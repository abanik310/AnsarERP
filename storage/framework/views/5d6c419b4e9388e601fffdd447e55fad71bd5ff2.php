<?php $__env->startSection('title','Revert Applicant Status'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('recruitment.applicant.revert_application_status'); ?>
    ...
    <script>
        GlobalApp.controller('applicantSearch', function ($scope, $http, $q, httpService, $sce, notificationService) {
            ...
            $scope.loadApplicant = function (url) {
                ...
                $http({
                    url: url || '<?php echo e(URL::route('recruitment.applicant.revert')); ?>',
                    method: 'post',
                    data: $scope.param
            ...
            $scope.revertStatus = function (data) {
                $scope.allLoading = true;
                $http({
                    url: '<?php echo e(URL::route('recruitment.applicant.revert_status')); ?>',
                    method: 'post',
                    data: data
                }).then(function (res) {
                    $scope.allLoading = false;
