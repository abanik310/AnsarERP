<?php $__env->startSection('title','Ansar Over Aged List'); ?>
    ...
    <script>
        GlobalApp.controller('ReportThreeYearsOverList', function ($scope, $http, $sce) {
            ...
            $scope.loadPage = function (page, $event) {
                ...
                $http({
                    url: '<?php echo e(URL::route('over_aged_ansar')); ?>',
                    method: 'get',
                    params: {
                ...
                <div class="box-body">
                    ...
                    <div id="print-three_years_over_ansar_report">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php /*<div class="table_pagination" ng-if="pages.length>1">*/ ?>
                            <?php /*<ul class="pagination">*/ ?>
                            <?php /*<li ng-class="{disabled:currentPage == 0}">*/ ?>
                            <?php /*<a href="#" ng-click="loadPage(pages[0],$event)">&laquo;&laquo;</a>*/ ?>
                            <?php /*</li>*/ ?>
                            <?php /*<li ng-class="{disabled:currentPage == 0}">*/ ?>
                            <?php /*<a href="#" ng-click="loadPage(pages[currentPage-1],$event)">&laquo;</a>*/ ?>
                            <?php /*</li>*/ ?>
                            <?php /*<li ng-repeat="page in pages|filter:filterMiddlePage"*/ ?>
                            <?php /*ng-class="{active:page.pageNum==currentPage&&!loadingPage[page.pageNum],disabled:!loadingPage[page.pageNum]&&loadingPage[currentPage]}">*/ ?>
                            <?php /*<span ng-show="currentPage == page.pageNum&&!loadingPage[page.pageNum]">[[page.pageNum+1]]</span>*/ ?>
                            <?php /*<a href="#" ng-click="loadPage(page,$event)" ng-hide="currentPage == page.pageNum||loadingPage[page.pageNum]">[[page.pageNum+1]]</a>*/ ?>
                            <?php /*<span ng-show="loadingPage[page.pageNum]"  style="position: relative"><i class="fa fa-spinner fa-pulse" style="position: absolute;top:10px;left: 50%;margin-left: -9px"></i>[[page.pageNum+1]]</span>*/ ?>
                            <?php /*</li>*/ ?>
                            <?php /*<li ng-class="{disabled:currentPage==pages.length-1}">*/ ?>
                            <?php /*<a href="#" ng-click="loadPage(pages[currentPage+1],$event)">&raquo;</a>*/ ?>
                            <?php /*</li>*/ ?>
                            <?php /*<li ng-class="{disabled:currentPage==pages.length-1}">*/ ?>
                            <?php /*<a href="#" ng-click="loadPage(pages[pages.length-1],$event)">&raquo;&raquo;</a>*/ ?>
                            <?php /*</li>*/ ?>
                            <?php /*</ul>*/ ?>
                            <?php /*</div>*/ ?>
                        </div>
