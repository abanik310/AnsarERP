<?php $__env->startSection('title','View Disembodied Report'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('disembodiment_report_view'); ?>
    ...
    <script>
        GlobalApp.controller('ReportAnsarDisembodiment', function ($scope, $http, $sce) {
            ...
            $scope.loadPage = function (page, $event) {
                ...
                $http({
                    url: '<?php echo e(URL::route('disemboded_ansar_info')); ?>',
                    method: 'get',
                    params: {
