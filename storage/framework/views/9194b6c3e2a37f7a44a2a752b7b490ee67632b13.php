<?php $__env->startSection('title','Job Category'); ?>
<?php $__env->startSection('small_title'); ?>
    <a href="<?php echo e(URL::route('recruitment.category.create')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-list"></i>&nbsp;Add New Category</a>
    <?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('job_category'); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr ng-repeat="jc in jobCategories">
                                ...
                                <td>
                                    <a href="<?php echo e(URL::to('/recruitment/category')); ?>/[[jc.id]]/edit" class="btn btn-primary btn-sm">
