<?php $__env->startSection('title','Cancel Offer'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('offer_cancel'); ?>
    ...
    <script>
        GlobalApp.controller('OfferCancelController', function ($scope, $http, $sce) {
            ...
            $scope.loadAnsar = function () {
                ...
                $http({
                    url: '<?php echo e(URL::to('HRM/get_offered_ansar_info')); ?>',
                    method: 'get',
                    params: {
            ...
            $scope.cancelUpdate = function () {
                ...
                $http({
                        url: "<?php echo e(URL::to('HRM/cancel_offer_handle')); ?>",
            ...
            <div class="box box-solid">
                <div class="box-body">
                    ...
                    <div class="row" style="padding-bottom: 10px">
                        <div class="col-md-4">
                            <label class="control-label"> <?php echo app('translator')->get('title.unit'); ?> to Cancel Offer&nbsp;&nbsp;&nbsp;<i
