<?php $__env->startSection('title','Embodiment'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('embodiment_entry'); ?>
    ...
    <script>
        GlobalApp.controller('NewEmbodimentController', function ($scope, $http, notificationService, $timeout, $rootScope) {
            ...
            $scope.loadAnsarDetail = function (id) {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::route('check-ansar')); ?>',
                    params: {
                        ansar_id: $scope.q,
            ...
            $scope.checkOTPEm = function(params) {
				//alert('Hello'+ params.otpValue);	
				...
				$http({
                    ...
                    function (response) {
						...
						if(response.data.status == 'success'){
							...
							$("#single-otp-embodied-modal").modal('hide');
							$("#embodied-modal").modal('show');
            ...
            $scope.submitEmbodiment = function () {
                ...
                $http({
                    ...
                    url: '<?php echo e(URL::route('new-embodiment-entry-multiple')); ?>'
                }).then(function (response) {
            ...
            $scope.saveBankInfo = function () {
                ...
                if (isSubmit) {
                    $http({
                        method: 'post',
                        url: '<?php echo e(URL::route('save-bank-info')); ?>',
                        params: formData
                    }).then(function (response) {
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="single-kpi">
                                ...
                                <form ng-submit="sendOffer()">
                                    <button  class="btn btn-primary pull-right" ng-disabled="ee"<
                             ...
                             <div class="modal modal-default fade" role="dialog" id="single-otp-embodied-modal">
                                        ...
                                        <div class="modal-body">
                                            <div style="width: 100%;height: 200px;">
                                                <div style="margin: auto;text-align:center;position: relative;top:50%;transform: translateY(-50%)">
                                                    <form ng-submit="checkOTPEm(params)">
                                                    ...
                                                    <div class="form-group text-right">
                                                        <button class="button btn-success" >Submit OTP</button>
                                                    </div>
                    ...
                    <div id="embodied-modal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <?php echo Form::open(array('route' => 'new-embodiment-entry', 'name' => 'newEmbodimentForm', 'novalidate','form-submit','errors','response-data'=>'responseData','loading','status','on-reset'=>'loadAnsarDetail()')); ?>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <?php echo Form::text('reporting_date', null, $attributes = array('class' => 'form-control', 'id' => 'reporting_date', 'ng-model' => 'reporting_date','date-picker'=>'', 'required')); ?>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <?php echo Form::text('joining_date', null, $attributes = array('class' => 'form-control', 'id' => 'joining_date','date-picker'=>'', 'ng-model' => 'joining_date','required')); ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group required">
                                        <label for="reporting_date" class="control-label">Reporting Date</label>
                                        <?php echo Form::text('reporting_date', null, $attributes = array('class' => 'form-control', 'id' => 'reporting_datee', 'ng-model' => 'reporting_datee','date-picker'=>'', 'required')); ?>
                                    ...
                                    <div class="form-group required">
                                        <label for="joining_date" class="control-label">Embodiment Date</label>
                                        <?php echo Form::text('joining_date', null, $attributes = array('class' => 'form-control', 'id' => 'joining_datee','date-picker'=>'', 'ng-model' => 'joining_datee','required')); ?>
