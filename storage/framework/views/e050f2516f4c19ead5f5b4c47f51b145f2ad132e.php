<?php $__env->startSection('title','Edit Applicants for HRM'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('recruitment.edit_applicant_for_hrm'); ?>
    ...
    <script>
        GlobalApp.controller('applicantSearch', function ($scope, $http, $q, httpService, $sce,$rootScope) {
            ...
            $scope.loadApplicant = function (url) {
                ...
                $http({
                    url:url||'<?php echo e(URL::route('recruitment.edit_for_hrm')); ?>',
                    method:'post',
                    data:$scope.param
...
//                    console.log($scope.formData)
            ...
            function updateData() {
                ...
                $http({
                    method: 'post',
                    data: $scope.formData,
                    url: '<?php echo e(URL::route('recruitment.store_hrm_detail')); ?>'
                }).then(function (response) {
                    $scope.allLoading = false;
