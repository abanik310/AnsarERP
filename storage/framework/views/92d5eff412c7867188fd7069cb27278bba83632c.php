...
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('user_registration'); ?>
    ...
    <script>
        GlobalApp.controller('userController', function ($scope, $http,httpService) {
            ...
            <?php foreach($types as $type): ?>
             $scope.userType.push({code: '<?php echo e($type->type_code); ?>', name: '<?php echo e($type->type_name); ?>'})
            <?php endforeach; ?>
            $scope.selectedUserType = '<?php echo e(Request::old('user_type')); ?>'
            var div = $http({
                url: '<?php echo e(URL::to('HRM/DivisionName')); ?>',
                type: 'get'
            });
            var dis = $http({
            ...
            var user = $http({
                url: '<?php echo e(URL::to('load_user')); ?>',
                type: 'get'
            })
            ...
            $scope.onUserTypeChange = function () {
                if ($scope.selectedUserType == 22) {
                    ...
                    $scope.showDD = false;
                    $scope.district = '<?php echo e(Request::old('district_name')); ?>'
                }
                    ...
                    $scope.showUsers = false;
                    $scope.showDD = false;
                    $scope.division = '<?php echo e(Request::old('division_name')); ?>'
                }
                    ...
                    $scope.user_parent = '<?php echo e(Request::old('user_parent')); ?>'
                }
            ...
            <div class="register-page" style="background-color: transparent;background: none;">
                <div class="register-box" style="margin: 4% auto 5% auto;width:50%;">
                    ...
                    <div class="register-box-body box-info" style="position: relative">
                        ...
                        <form action="<?php echo e(action('UserController@handleRegister')); ?>" method="post"
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <div class="col-sm-9 <?php if($errors->has('user_name')): ?> has-error <?php endif; ?>">
                                    <input type="text" name="user_name" value="<?php echo e(Request::old('user_name')); ?>"
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <div class="col-sm-9 <?php if($errors->has('password')): ?> has-error <?php endif; ?>">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <div class="col-sm-9 <?php if($errors->has('r_password')): ?> has-error <?php endif; ?>">
                                    <input type="password" name="r_password" class="form-control"
                                           placeholder="Retype password"/>
                                    <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
                                    <?php if($errors->has('r_password')): ?>
                                        <p class="text-danger"><?php echo e($errors->first('r_password')); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="form-group has-feedback">
                            ...
                            <div class="form-group has-feedback" ng-show="showDistrict">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <?php if($errors->has('district_name')): ?>
                                        <p class="text-danger"><?php echo e($errors->first('district_name')); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="form-group has-feedback" ng-show="showDivision">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <?php if($errors->has('division_name')): ?>
                                        <p class="text-danger"><?php echo e($errors->first('division_name')); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="form-group has-feedback" ng-show="showUsers">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <?php if($errors->has('user_parent')): ?>
                                        <p class="text-danger"><?php echo e($errors->first('user_parent')); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="form-group has-feedback" ng-show="showDD">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <?php if($errors->has('divisions')): ?>
                                        <p class="text-danger"><?php echo e($errors->first('divisions')); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="form-group has-feedback" ng-show="showDD">
