<?php $__env->startSection('title','Entry Form'); ?>
<?php /*<?php $__env->startSection('small_title','Add new ansar'); ?>*/ ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('entryform'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        ...
        GlobalApp.controller('fullEntryFormController', function ($scope, getNameService, getBloodService, getDiseaseSkillService, $sce,$http) {
            ...
            $http({
                url:'<?php echo e(URL::to('HRM/ansar_rank')); ?>',
                method:'get'
            ...
            $scope.loadSession = function () {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::to('HRM/session_name')); ?>',
                    //params: {id: id}
                }).then(function (response) {
        ...
        GlobalApp.factory('getBloodService', function ($http) {
            return {
                getAllBloodName: function () {
                    return $http.get("<?php echo e(URL::to('HRM/getBloodName')); ?>")
                }
            }
        });
        ...
        GlobalApp.factory('getDiseaseSkillService', function ($http) {
            return {
                getAllDisease: function () {
                    return $http.get("<?php echo e(URL::to('HRM/getDiseaseName')); ?>")
                },
                getAllSkill: function () {
                    return $http.get("<?php echo e(URL::to('HRM/getallskill')); ?>")
                },
                getAllEducationName: function () {
                    return $http.get("<?php echo e(URL::to('HRM/getalleducation')); ?>")
                }
            }
    ...
    <div id="entryform" ng-controller="fullEntryFormController" d-picker>
        ...
        <div>
            ...
            <section class="content">
                    ...
                    <div>
                        ...
                        <div id="entryform">
                            <form id="pppp" class="form-horizontal" enctype="multipart/form-data" id="myForm"
                                  method="post" action="<?php echo e(URL::to('HRM/handleregistration')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <fieldset>
                                    ...
                                    <div class="box box-info">
                                        <div class="box-body">
                                            <div class="form-horizontal col-md-12" ng-show="isAdmin==55">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select name="session_id" ng-model="selectedSession"
                                                            class="form-control" id="session_id" value="<?php echo e(Request::old('selectedSession')); ?>">
                                            ...
                                            <?php /*Start Ansar Name (English) Field */ ?>
                                            <div class="form group col-md-12"
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control " name="ansar_name_eng"
                                                           ...
                                                           value="<?php echo e(Request::old('ansar_name_eng')); ?>"/>
                                                    <span style="color:red"
                                                          ng-show="formSubmitResult.error.ansar_name_eng[0]">[[ formSubmitResult.error.ansar_name_eng[0] ]]</span>
                                                </div>

                                            </div>
                                            <?php /*End Ansar Name (English) Field */ ?>
                                            <?php /*Start Ansar Name (Bangla) Field */ ?>
                                            <div class="form-horizontal col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="ansar_name_bng"
                                                           ...
                                                           value="<?php echo e(Request::old('ansar_name_bng')); ?>"/>
                                                    <span style="color:red"
                                                          ng-show="formSubmitResult.error.ansar_name_bng[0]">[[ formSubmitResult.error.ansar_name_bng[0] ]]</span>
                                                </div>
                                            </div>
                                            <?php /*End Ansar Name (Bangla) Field */ ?>
                                            <?php /*Start Ansar Rank Field */ ?>
                                            <div class="form-horizontal col-md-12 "
                                            ...
                                            <?php /*End Ansar Rank Field */ ?>
                                            <?php /*Start Ansar Father Name (English) Field */ ?>
                                            <div class="form group col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" id="father_name_eng"
                                                           ...
                                                           value="<?php echo e(Request::old('father_name_eng')); ?>">
                                                    <span style="color:red"
                                                          ng-show="formSubmitResult.error.father_name_eng[0]">[[ formSubmitResult.error.father_name_eng[0] ]]</span>
                                                </div>
                                            </div>
                                            <?php /*End Ansar Father Name (English) Field */ ?>
                                            <?php /*Start Ansar Father Name (Bangla) Field */ ?>
                                            <div class="form group col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control " id="father_name_bng"
                                                           ...
                                                           value="<?php echo e(Request::old('father_name_bng')); ?>">
                                                    <span style="color:red"
                                                          ng-show="formSubmitResult.error.father_name_bng[0]">[[ formSubmitResult.error.father_name_bng[0] ]]</span>
                                                </div>
                                            </div>
                                            <?php /*End Ansar Father Name (Bangla) Field */ ?>
                                            <?php /*Start Ansar Mother Name (English) Field */ ?>
                                            <div class="form group col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="mother_name_eng"
                                                           ...
                                                           value="<?php echo e(Request::old('mother_name_eng')); ?>">
                                                    <span style="color:red"
                                                          ng-show="formSubmitResult.error.mother_name_eng[0]">[[ formSubmitResult.error.mother_name_eng[0] ]]</span>
                                                </div>
                                            </div>
                                            <?php /*End Ansar Mother Name (English) Field */ ?>
                                            <?php /*Start Ansar Mother Name (Bangla) Field */ ?>
                                            <div class="form group col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="mother_name_bng"
                                                           ...
                                                           value="<?php echo e(Request::old('mother_name_bng')); ?>">
                                                    <span style="color:red"
                                                          ng-show="formSubmitResult.error.mother_name_bng[0]">[[ formSubmitResult.error.mother_name_bng[0] ]]</span>
                                                </div>

                                            </div>
                                            <?php /*End Ansar Mother Name (Bangla) Field */ ?>
                                            <?php /*Start Ansar Date of Birth Field */ ?>
                                            <div class="form group col-md-12 "
                                              $scope.loadPagination();   ng-class="{'has-error':formSubmitResult.status==false&&formSubmitResult.error.data_of_birth[0]}">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control picker " id="data_of_birth" name="data_of_birth" ng-model="data_of_birth" date-picker="" placeholder="Date of birth" value="<?php echo e(Request::old('data_of_birth')); ?>">
                                                    <span style="color:red" ng-show="formSubmitResult.error.data_of_birth[0]">[[ formSubmitResult.error.data_of_birth[0] ]]</span>
                                                </div>
                                            </div>
                                            <?php /*End Ansar Date of Birth Field */ ?>
                                            <?php /*Start Ansar Married Status Field */ ?>
                                            <div class="form-horizontal col-md-12 "
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select name="marital_status" ng-model="marital_status"
                                                        ...
                                                        <option value="Married"
                                                                <?php if(Request::old('marital_status')=='Married'): ?> selected <?php endif; ?>>
                                                            Married
                                                        </option>
                                                        <option value="Unmarried"
                                                                <?php if(Request::old('marital_status')=='Unmarried'): ?> selected <?php endif; ?>>
                                                            Unmarried
                                                        </option>
                                            ...
                                            <?php /*End Ansar Married Status Field */ ?>
                                            ...
                                            <div class="form group col-md-12 ">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="spouse_name_eng"
                                                           ...
                                                           value="<?php echo e(Request::old('spouse_name_eng')); ?>">
                                            ...
                                            <div class="form group col-md-12 ">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="spouse_name_bng" name="spouse_name_bng" ng-model="spouse_name_bng" type="text" placeholder=" স্ত্রী/স্বামীর নাম " value="<?php echo e(Request::old('spouse_name_bng')); ?>">
                                                </div>

                                            </div>
                                            <?php /*Start Ansar National Id Field */ ?>
                                            <div class="form group col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="national_id_no"
                                                           ...
                                                           value="<?php echo e(Request::old('national_id_no')); ?>">
                                                    <span style="color:red"
                                                          ng-show="formSubmitResult.error.national_id_no[0]">[[ formSubmitResult.error.national_id_no[0] ]]</span>
                                                </div>

                                            </div>
                                            <?php /*End Ansar National Id Field */ ?>
                                            <div class="form group col-md-12 ">
                                                <label class="control-label col-sm-2" for="email">Birth Certificate no</label>

                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="birth_certificate_no" name="birth_certificate_no" ng-model="birth_certificate_no" type="text" placeholder="Birth Certificate no" value="<?php echo e(Request::old('birth_certificate_no')); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control"  name="criminal_case" ng-model="criminal_case" type="text" placeholder="Criminal case" value="<?php echo e(Request::old('criminal_case')); ?>">
                                                </div>
                                            </div>
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" name="criminal_case_bng" type="text" placeholder="ফৌজদারি মামলা" value="<?php echo e(Request::old('criminal_case')); ?>">
                                                </div>
                                            </div>
                                            <?php /*<div class="form group col-md-12 hiddden">*/ ?>
                                                <?php /*<label class="control-label col-sm-2" for="criminal">সর্বশেষ প্রশিক্ষন সনদ নং:</label>*/ ?>
                                                <?php /*<div class="col-sm-10">*/ ?>
                                                    <?php /*<input class="form-control  " id="certificate_no" name="certificate_no" type="text" placeholder="সর্বশেষ প্রশিক্ষন সনদ নং" value="<?php echo e(Request::old('certificate_no')); ?>">*/ ?>
                                                <?php /*</div>*/ ?>
                                            <?php /*</div>*/ ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box box-info">
                                        <div class="box-body">
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="village_name" name="village_name" ng-model="village_name" type="text" placeholder=" Village" value="<?php echo e(Request::old('village_name')); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="village_name_bng" name="village_name_bng" ng-model="village_name_bng" type="text" placeholder=" গ্রাম" value="<?php echo e(Request::old('village_name_bng')); ?>">
                                                </div>
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="road_no" name="road_no" ng-model="road_no" type="text" placeholder=" Road no" value="<?php echo e(Request::old('road_no')); ?>">
                                                </div>
                                            </div>
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="post_office_name" name="post_office_name" ng-model="post_office_name" type="text" placeholder=" Post Office Name " value="<?php echo e(Request::old('post_office_name')); ?>">
                                                </div>
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="post_office_name_bng" name="post_office_name_bng" ng-model="post_office_name_bng" type="text" placeholder=" ডাকঘর " value="<?php echo e(Request::old('post_office_name_bng')); ?>">
                                                </div>
                                            ...
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="union_name_eng" name="union_name_eng" ng-model="union_name_eng" type="text" placeholder=" Union Name" value="<?php echo e(Request::old('union_name_eng')); ?>">
                                                </div>
                                            </div>
                                            <div class="form group col-md-12">
                                                <label class="control-label col-sm-2" for="email">ইউনিয়ন নাম/ওয়ার্ড:</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" id="union_name_bng" name="union_name_bng" ng-model="union_name_bng" type="text" placeholder="ইউনিয়ন নাম" value="<?php echo e(Request::old('union_name_bng')); ?>">
                                                </div>
                                            </div>
                                            <div class="form-horizontal col-md-12 " ng-class="{'has-error':formSubmitResult.status==false&&formSubmitResult.error.division_name_eng[0]}">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select  name="division_name_eng" ng-disabled="disableDDT" class="form-control" id="sell" ng-model="SelectedDivision" ng-change="SelectedItemChanged()">
                                                        ...
                                                        <option ng-repeat="x in division" ng-selected="x.id=='<?php echo e(Request::old('division_name_eng')); ?>'" value="[[x.id]]">[[x.division_name_bng]]</option>
                                                    </select>
                                            ...
                                            <div class="form-horizontal col-md-12 " ng-class="{'has-error':formSubmitResult.status==false&&formSubmitResult.error.unit_name_eng[0]}">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select ng-disabled="disableDDT" name="unit_name_eng" class="form-control" id="sell" ng-model="SelectedDistrict" ng-change="SelectedDistrictChanged()">
                                                        ...
                                                        <option ng-repeat="x in district" ng-selected="x.id=='<?php echo e(Request::old('unit_name_eng')); ?>'" value="[[x.id]]">[[ x.unit_name_bng ]]
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="form-horizontal col-md-12 " ng-class="{'has-error':formSubmitResult.status==false&&formSubmitResult.error.thana_name_eng[0]}">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select ng-disabled="disableDDT" name="thana_name_eng" class="form-control" id="sell" ng-model="ThanaModel" ng-change="SelectedThanaChanged()">
                                                        ...
                                                        <option ng-repeat="x in thana" ng-selected="x.id=='<?php echo e(Request::old('thana_name_eng')); ?>'" value="[[x.id]]">[[ x.thana_name_bng ]]</option>
                                                    </select>
                                    ...
                                    <div class="box box-info">
                                        <div class="box-body">
                                            <div class="form-horizontal col-md-12 " ng-class="{'has-error':formSubmitResult.status==false&&formSubmitResult.error.hight_feet[0]}">
                                                ...
                                                <div class="col-sm-5">
                                                    <input class="form-control  " id="hight_feet" name="hight_feet" ng-model="hight_feet" type="text" placeholder=" FEET" value="<?php echo e(Request::old('hight_feet')); ?>">
                                                    <span style="color:red" ng-show="formSubmitResult.error.hight_feet[0]">[[ formSubmitResult.error.hight_feet[0] ]]</span>
                                                </div>
                                                <div class="col-sm-5">
                                                    <input class="form-control  " id="hight_inch" name="hight_inch" ng-model="hight_inch" ng-change="hight_inch=hight_inch>=12?11:hight_inch" type="text" placeholder=" INCHES" value="<?php echo e(Request::old('hight_inch')); ?>">
                                                </div>
                                            </div>
                                            <div class="form-horizontal col-md-12 " ng-class="{'has-error':formSubmitResult.status==false&&formSubmitResult.error.ansar_name_eng[0]}">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select name="blood_group_name_bng" class="form-control" id="sell" ng-model="BloodModel">
                                                        ...
                                                        <option ng-repeat="x in blood" ng-selected="x.id=='<?php echo e(Request::old('blood_group_name_bng')); ?>'" value="[[x.id]]">[[ x.blood_group_name_bng ]]</option>
                                                    </select>
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="eye_color" name="eye_color" ng-model="eye_color" type="text" placeholder="Eye color" value="<?php echo e(Request::old('eye_color')); ?>">
                                                </div>
                                            </div>
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="eye_color" name="eye_color_bng" ng-model="eye_color_bng" type="text" placeholder="চোখের রং" value="<?php echo e(Request::old('eye_color_bng')); ?>">
                                                </div>
                                            </div>
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="skin_color" name="skin_color" ng-model="skin_color" type="text" placeholder="Skin color" value="<?php echo e(Request::old('skin_color')); ?>">
                                                </div>
                                            </div>
                                            <div class="form group col-md-12">
                                                <label class="control-label col-sm-2" for="skin_color_bng">গায়ের রং:</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="skin_color_bng" name="skin_color_bng" ng-model="skin_color_bng" type="text" placeholder="গায়ের রং" value="<?php echo e(Request::old('skin_color_bng')); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-horizontal col-md-12 " ng-class="{'has-error':formSubmitResult.status==false&&formSubmitResult.error.sex[0]}">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select name="sex" ng-model="sex" class="form-control" id="sell">
                                                        ...
                                                        <option value="Male"
                                                                <?php if(Request::old('sex')=='Male'): ?> selected <?php endif; ?>>Male
                                                        </option>
                                                        <option value="Female"
                                                                <?php if(Request::old('sex')=='Female'): ?> selected <?php endif; ?>>Female
                                                        </option>
                                                        <option value="Other"
                                                                <?php if(Request::old('sex')=='Other'): ?> selected <?php endif; ?>>Other
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="identification_mark" name="identification_mark" ng-model="identification_mark" type="text" placeholder="Identification mark" value="<?php echo e(Request::old('identification_mark')); ?>">
                                                </div>
                                            </div>
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="identification_mark_bng" name="identification_mark_bng" ng-model="identification_mark_bng" type="text" placeholder="সনাক্তকরন চিহ্ন" value="<?php echo e(Request::old('identification_mark')); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box box-info">
                                        <div class="box-body">
                                            <div class="form-horizontal col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control  " id="mobile_no_self" name="mobile_no_self" ng-model="mobile_no_self" ng-change="mobile_no_self=mobile_no_self.length>11?mobile_no_self.substring(0,11):mobile_no_self" type="text" placeholder="Mobile no(Self)" value="<?php echo e(Request::old('mobile_no_self')); ?>">
                                                    </div>
                                                    <span style="color:red"
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="mobile_no_request"
                                                           ...
                                                           type="text" placeholder="Mobile no(Request)"
                                                           value="<?php echo e(Request::old('mobile_no_request')); ?>">
                                                </div>
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="land_phone_self"
                                                           ...
                                                           value="<?php echo e(Request::old('land_phone_self')); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="land_phone_request" name="land_phone_request" ng-model="land_phone_request" type="text" placeholder="Land phone no(request)" value="<?php echo e(Request::old('land_phone_request')); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-horizontal col-md-12 ">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="email_self" name="email_self" ng-model="email_self" type="email" placeholder="Email(Self)" value="<?php echo e(Request::old('email_self')); ?>">
                                                </div>
                                            </div>
                                            <div class="form-horizontal col-md-12">
                                                <label class="control-label col-sm-2" for="email">Email(Request):</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="email_request" name="email_request" ng-model="email_request" type="email" placeholder="Email(Request)" value="<?php echo e(Request::old('email_request')); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                                <?php /*All Photos Field*/ ?>
                                <fieldset>
                                    <div class="level-title-session-entry">
                ...
                <?php /*<div ng-bind-html="error"></div>*/ ?>
            </section>
        </div>
    </div>
<?php $__env->stopSection(); ?>
