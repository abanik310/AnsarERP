<?php $__env->startSection('title','Disembodiment Date Correction'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('disembodiment_date_correction'); ?>
    ...
    <script>
        GlobalApp.controller('DisembodimentDateCorrectionController', function ($scope, $http, $sce) {
            ...
            $scope.loadAnsarDetail = function (id) {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::route('load_ansar_for_disembodiment_date_correction')); ?>',
                    params: {ansar_id: id}
    ...
    <div ng-controller="DisembodimentDateCorrectionController">
        ...
        <section class="content" style="position: relative;">
            ...
            <div class="box box-solid">
                <?php echo Form::open(array('route' => 'new-disembodiment-date-entry', 'id' => 'new-disembodiment-date-entry')); ?>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group required"
                                 ng-init="new_disembodiment_date='<?php echo e(Request::old('new_disembodiment_date')); ?>'">
                                <datepicker-separate-fields label="New Disembodiment Date" notify="disEmboInvalidDate"
                                                            rdata="new_disembodiment_date"></datepicker-separate-fields>
                                <input type="hidden" name="new_disembodiment_date" ng-value="new_disembodiment_date">
                                <?php if($errors->has('new_disembodiment_date')): ?>
                                    <p class="text-danger"><?php echo e($errors->first('new_disembodiment_date')); ?></p>
                                <?php endif; ?>
                            </div>
                            <button id="confirm-new-disembodiment-date" class="btn btn-primary"
                                    ng-disabled="disEmboInvalidDate">
                                <img ng-show="loadingSubmit" src="<?php echo e(asset('dist/img/facebook-white.gif')); ?>" width="16"
                                     style="margin-top: -2px">Correct Date
                            </button>
                        </div>
