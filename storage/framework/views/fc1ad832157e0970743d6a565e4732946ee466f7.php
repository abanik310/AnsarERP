<?php $__env->startSection('title','Freezed Ansar List'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('freezelist'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        GlobalApp.controller('freezeController', function ($scope, $http, notificationService, $sce) {
            ...
            var userType = parseInt('<?php echo e(auth()->user()->type); ?>');
            $scope.loadKpi = function () {
                $scope.loadingKpi = true;
                $http({
                    url: '<?php echo e(URL::route('kpi_name')); ?>',
            ...
            $scope.loadThana = function () {
                ...
                $http({
                    url: "<?php echo e(URL::to('HRM/ThanaName')); ?>",
                    method: 'get',
            ...
            switch (userType) {
                case 22:
                    $scope.isDc = true;
                    $scope.child.selectedUnit = parseInt('<?php echo e(auth()->user()->district_id); ?>');
                    $scope.loadThana();
                    break;
                case 66:
                    $scope.isRC = true;
            ...
            $scope.getFreezeList = function (url) {
                ...
                $http({
                    url: url || "<?php echo e(URL::route('getfreezelist')); ?>",
                    method: 'get',
                    params: data
                }).then(function (response) {
            ...
            $scope.reEmbodied = function (ansarids, date, ifd) {
                ...
                $http({
                    url: "<?php echo e(URL::to('HRM/freezeRembodied')); ?>",
                    method: 'post',
            ...
            $scope.transferAnsar = function (ansarId) {
                ...
                $scope.printLetter = false;
                $http({
                    url: '<?php echo e(URL::route('transfer_freezed_ansar')); ?>',
                    method: 'post',
            ...
            $scope.checkMemorandum = function (id, type) {
                ...
                $http({
                    url: "<?php echo e(action('UserController@verifyMemorandumId')); ?>",
                    method: 'post',
            ...
            $scope.disEmbodied = function (ansarid) {
                if (ansarid) {
                    $scope.submitting = true;
                    $http({
                        url: "<?php echo e(URL::to('HRM/freezeDisEmbodied')); ?>",
                        method: 'post',
                        data: angular.toJson({
            ...
            $scope.blackAnsar = function (ansarids) {
                ...
                $scope.submitting = true;
                $http({
                    url: "<?php echo e(URL::to('HRM/freezeblack')); ?>",
                    method: 'post',
                                ...
                                <table class="table  table-bordered table-striped" id="ansar-table">
                                    <caption>
                                        ...
                                        <a class="btn btn-primary btn-xs"
                                           href="<?php echo e(URL::route('getfreezelist',['export'=>1])); ?>">
                                    ...
                                    <tr ng-show="allFreezeAnsar.length>0"
                                        ...
                                        <td>
                                            <a href="<?php echo e(URL::to('/HRM/entryreport/')); ?>/[[freezeAnsar.ansar_id]]">[[freezeAnsar.ansar_id]]</a>
                                        </td>
                ...
                <div class="box-body modal-content">
                    <form class="form" role="form" method="post"
                        ...
                        <div class="modal-body">
                            ...
                            <?php if(UserPermission::userPermissionExists('include_freeze_days')): ?>
                                <div class="form-group">
        ...
        <div id="re-embodied-model" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="box-body modal-content">
                        ...
                        <div class="modal-body row">
                            ...
                            <div class="form-group required col-md-offset-1 col-md-10">
                                ...
                                <select ng-disabled="loadingThana||loadingKpi" ng-model="selectedThana" name="thana"
                                    ...
                                    <option value="">---<?php echo app('translator')->get('title.thana'); ?>---</option>
                            ...
                            <div class="form-group required col-md-offset-1 col-md-10">
                                ...
                                <select ng-disabled="loadingKpi||loadingThana" ng-model="transferData.selectedKpi"
                                    ...
                                    <option value="">---<?php echo app('translator')->get('title.kpi'); ?>---</option>
                    ...
                    <form method="post" ng-if="printLetter" target="_blank" action="<?php echo e(URL::to('HRM/print_letter')); ?>">
                        <?php echo csrf_field(); ?>
