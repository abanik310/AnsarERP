<?php $__env->startSection('title','Applicant Quota'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('recruitment.setting.applicant_quota'); ?>
        ...
        GlobalApp.controller('applicantQuota', function ($scope, $http, $q, httpService, notificationService) {
            ...
            $scope.submitData = function (index, male, female) {
                ...
                $http({
                    method: 'post',
                    data: data,
                    url: '<?php echo e(URL::route('recruitment.quota.update')); ?>'
                }).then(function (response) {
                    $scope.allLoading = false;
