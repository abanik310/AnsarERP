<?php $__env->startSection('title','Withdraw Ansar'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('ansar_withdraw_view'); ?>
    ...
    <script>
        ...
        GlobalApp.controller('ReportGuardSearchController', function ($scope, $http, $sce) {
            ...
            $scope.loadAnsar = function (param) {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::route('ansar_list_for_withdraw')); ?>',
                    params: param
        ...
        <?php if(Session::has('error_message')): ?>
            <div style="padding: 10px 20px 0 20px;">
                <div class="alert alert-danger">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <span class="fa fa-warning"></span> <?php echo e(Session::get('error_message')); ?>
            ...
            <div id="withrdaw-option" class="modal fade" role="dialog">
                <div class="modal-dialog" style="width: 80%;overflow: auto;">
                    <div class="modal-content">
                        <?php echo Form::open(array('route' => 'ansar-withdraw-update', 'name' => 'kpiWithdrawForm', 'id'=> 'kpi-form', 'ng-app' => 'myValidateApp', 'novalidate','form-submit','errors','response-data'=>'responseData','loading','status')); ?>

                        <?php echo Form::hidden('kpi_id_withdraw','[[params.kpi]]'); ?>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Reason for
                                                    Withdrawal:&nbsp;&nbsp;&nbsp;</label>
                                                <?php echo Form::text('kpi_withdraw_reason', $value = "", $attributes = array('class' => 'form-control', 'id' => 'kpi_withdraw_reason', 'ng_model' => 'kpi_withdraw_reason', 'required')); ?>
