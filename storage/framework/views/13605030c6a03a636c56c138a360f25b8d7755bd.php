<?php $__env->startSection('title','Direct Embodiment'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('direct_embodiment'); ?>
    ...
    <script>
        GlobalApp.controller('DirectEmbodimentController', function ($scope, $timeout, $http, notificationService) {
            ...
            $scope.loadAnsarDetail = function (id) {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::route('direct_embodiment_ansar_details')); ?>',
                    params: {ansar_id: id}
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-4">
						   ...
						   <form action="<?php echo e(URL::to('HRM/direct_embodiment_submit')); ?>" method="post" form-submit
