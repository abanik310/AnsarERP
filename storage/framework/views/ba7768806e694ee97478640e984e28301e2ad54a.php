<?php $__env->startSection('title','Applicants Mark Entry'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('recruitment.applicant.applicant_mark_entry'); ?>
...
//            $scope.limitList = p = '50';
            ...
            $scope.loadApplicant = function (url) {
                ...
                var link = url || '<?php echo e(URL::route('recruitment.marks.index')); ?>'
                $scope.allLoading = true;
                $http({
                    url:link,
                    params:$scope.param,
            ...
            $scope.editMark = function (id) {
                ...
                var link = '<?php echo e(URL::to('recruitment/marks')); ?>/'+id+"/edit"
                $http({
                    url:link,
                }).then(function (response) {
