<?php $__env->startSection('title','Training Setting'); ?>
    ...
    <section class="content">
        <div class="box box-solid">
            <div class="box-header">
                <a href="<?php echo e(URL::route('HRM.main_training.create')); ?>" title="New Training Info" class="btn btn-primary btn-sm pull-right">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <?php $__empty_1 = true; foreach($data as $training): $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <a title="Edit" href="<?php echo e(URL::route('HRM.main_training.edit',['main_training'=>$training->id])); ?>" class="btn btn-primary btn-xs">
