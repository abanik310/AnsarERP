<?php $__env->startSection('title','Direct Cancel Panel'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('direct_cancel_panel'); ?>
    ...
    <script>
        GlobalApp.controller('DGCancelPanelController', function ($scope, $http, $sce) {
            ...
            $scope.loadAnsarDetail = function (id) {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::to('HRM/cancel_panel_ansar_details')); ?>',
                    params: {ansar_id: id}
        ...
        <section class="content" style="position: relative;">
            <div class="box box-solid">
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-4">
                            <?php echo Form::open(array('url' => 'HRM/cancel_panel_entry_for_dg', 'id' => 'cancel_panel_entry_for_dg')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo $errors->first('cancel_panel_date','<p class="text text-danger">:message</p>'); ?>

                            </div>
                            <div class="form-group">
                                <label for="cancel_panel_comment" class="control-label">Comment for Canceling
                                    Panel</label>
                                <?php echo Form::textarea('cancel_panel_comment', $value = null, $attributes = array('class' => 'form-control', 'id' => 'cancel_panel_comment', 'size' => '30x4', 'placeholder' => "Write Comment", 'ng-model' => 'cancel_panel_comment')); ?>
