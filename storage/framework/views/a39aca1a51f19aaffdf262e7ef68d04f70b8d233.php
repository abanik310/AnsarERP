<?php $__env->startSection('title','Blacklist Info'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('blacklist_view'); ?>
    ...
    <script>
        GlobalApp.controller('BlackListReportController', function ($scope, $http, $sce) {
            ...
            $scope.loadPage = function (page, $event) {
                ...
                $http({
                    url: '<?php echo e(URL::route('blacklisted_ansar_info')); ?>',
                    method: 'get',
                    params: {
            ...
            $scope.loadReportData("blacklisted_ansar_report", "eng");
        });
        $(function () {
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    <div class="pull-right">
                            <span class="control-label" style="padding: 5px 8px">
                                View report in&nbsp;&nbsp;&nbsp;<input type="radio" class="radio-inline"
                                                                       ...
                                                                       ng-change="loadReportData('blacklisted_ansar_report',reportType)"
                    ...
                    <filter-template
                            ...
                            start-load="range"
                            field-width="{range:'col-sm-2',unit:'col-sm-3',thana:'col-sm-2',gender:'col-sm-3',rank:'col-sm-2'}"
                            data="param"
                            on-load="loadPage()"
                    ></filter-template>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr ng-repeat="a in ansars.ansars">
                                    ...
                                    <td>[[a.black_listed_date|dateformat:'DD-MMM-YYYY']]</td>
                                </tr>
