...
<?php $__env->startSection('title','Active KPI Information'); ?>
<?php $__env->startSection('small_title'); ?>
    <a href="<?php echo e(URL::route('go_to_kpi_page')); ?>" class="btn btn-sm btn-info"><span><i class="fa fa-plus"></i></span>&nbsp;&nbsp;Add New KPI</a>
    <?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('kpi_view'); ?>
    ...
    <script>
        GlobalApp.controller('KpiViewController', function ($scope, $http, $sce, httpService) {
            ...
            $scope.loadPage = function (page, $event) {
                ...
                $http({
                    url: '<?php echo e(URL::route('kpi_view_details')); ?>',
                    method: 'get',
                    params: {
...
//                    $compile($scope.ansars)
					...
					$scope.total_embodied = Number(response.data.total_embodied[0].total_embodied);
...
<!--                                <div class="col-md-2 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-md-8">
							...
							<h4>Total Embodied: [[total_embodied.toLocaleString()]]</h4>
						</div>
                        <div class="col-md-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr ng-if="kpis.length>0" ng-repeat="a in kpis">
                                ...
                                <td>
                                    <div class="col-xs-1">
                                        <a href="<?php echo e(URL::to('HRM/kpi-edit/'.'[[a.id]]')); ?>" class="btn btn-primary btn-xs" title="Edit">
