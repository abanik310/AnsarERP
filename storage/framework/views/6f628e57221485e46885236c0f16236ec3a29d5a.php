<?php $__env->startSection('title','View Previous Service Record'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('ansar_service_report_view'); ?>
        ...
        GlobalApp.controller('serviceRecordController', function ($scope, $http) {
            ...
            $scope.loadAnsarServiceRecord = function (event) {
                if (event == undefined || event.keyCode == 13) {
                    ...
                    $http({
                        method: 'get',
                        url: '<?php echo e(URL::route('ansar_service_report')); ?>',
                            ...
                            <table class="table " style="width: auto">
                                <tr>
                                    ...
                                    <td style="background: #ffffff" rowspan="4" align="center" valign="middle">
                                        <img src="<?php echo e(URL::to('image').'?file='); ?>[[ansar.profile_pic]]" class="img-thumbnail"
