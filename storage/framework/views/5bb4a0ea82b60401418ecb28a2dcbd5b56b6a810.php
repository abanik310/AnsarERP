<?php $__env->startSection('title','Applicant Editable fields'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('recruitment.setting.applicant_editable_field'); ?>
    ...
    <script>
        GlobalApp.controller('applicantQuota', function ($scope, $http, $q, httpService,notificationService) {
            ...
            $scope.saveField = function () {
                $scope.allLoading = true;
                $http({
                    url:'<?php echo e(URL::route('recruitment.applicant.editfieldstore')); ?>',
                    data:{
                        fields:$scope.rows
                    },
                    method:'post'
