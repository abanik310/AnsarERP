...
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('edit_user',$id); ?>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-4">
                        ...
                        <form id="user-name-form" action="<?php echo e(action('UserController@changeUserName')); ?>" method="post">
                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-4" style="margin-bottom: 20px">
                        ...
                        <form id="user-password-form" action="<?php echo e(action('UserController@changeUserPassword')); ?>"
                              method="post">
                            <input type="hidden" name="user_id" value="<?php echo e($id); ?>">
                            <div class="form-group has-feedback">
                ...
                <?php if($user->type==22): ?>
                    <div class="row">
                        <div class="col-sm-4 col-sm-offset-4">
                            ...
                            <form id="user-unit-form" action="<?php echo e(action('UserController@changeUserDistrict')); ?>"
                                  method="post">
                                <input type="hidden" name="user_id" value="<?php echo e($id); ?>">
                                <div class="form-group has-feedback">
                                    <label for="">Change recruitment unit</label>
                                    <?php echo Form::select('rec_district_id',$units,$user->rec_district_id,['class'=>'form-control']); ?>
                ...
                <?php elseif($user->type==111): ?>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-sm-offset-4">
                            ...
                            <form id="user-unit-range-form" action="<?php echo e(action('UserController@changeUserDistrictDivision')); ?>"
                                  method="post">
                                <input type="hidden" name="user_id" value="<?php echo e($id); ?>">
                                <div class="form-group has-feedback">
                                        ...
                                        <?php foreach($divisions as $key=>$value): ?>
                                            <label style="display:block">
                                                <input type="checkbox" class="range" name="divisions[]"
                                                       value="<?php echo e($key); ?>" <?php echo e(in_array($key,$ranges)?"checked":""); ?>>&nbsp;<?php echo e($value); ?>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div style="max-height:150px;overflow: auto">
                                        <?php foreach($districts as $d): ?>
                                            <label data-division-id="<?php echo e($d->division_id); ?>" <?php echo e(!in_array($d->division_id,$ranges)?'style=display:none':'style=display:block'); ?>>
                                                <input type="checkbox" name="districts[]"
                                                       value="<?php echo e($d->id); ?>" <?php echo e(in_array($d->id,$units)?"checked":""); ?>>&nbsp;<?php echo e($d->unit_name_bng); ?>
                                        ...
                                        <?php foreach($categories as $d): ?>
                                            <label style="display: block">
                                                <input type="checkbox" name="categories[]"
                                                       value="<?php echo e($d->id); ?>" <?php echo e(in_array($d->id,$cat)?"checked":""); ?>>&nbsp;<?php echo e($d->category_name_bng); ?>
