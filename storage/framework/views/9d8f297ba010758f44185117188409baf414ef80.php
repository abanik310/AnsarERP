<?php $__env->startSection('title','Direct Dis-Embodiment'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('direct_disembodiment'); ?>
...
<?php $__env->startSection('content'); ?>
    <script>
        GlobalApp.controller('DirectEmbodimentController', function ($scope, $http, $sce, notificationService) {
            ...
            $http({
                method: 'get',
                url: '<?php echo e(URL::to('HRM/load_disembodiment_reason')); ?>'
            ...
            $scope.loadAnsarDetail = function (id) {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::route('direct_disembodiment_ansar_details')); ?>',
                    params: {ansar_id: id}
                }).then(function (response) {
            ...
            $scope.checkFile = function (url) {
                $http({
                    url: '<?php echo e(URL::to('HRM/check_file')); ?>',
                    params: {path: url},
                    method: 'get'
                }).then(function (response) {
    ...
    <div ng-controller="DirectEmbodimentController">
        <section class="content">
            ...
            <div class="box box-solid">
                <div class="box-body">
                    <?php echo Form::open(['route'=>'direct_disembodiment_submit','form-submit','errors','loading'=>'loadingSubmit','on-reset'=>'reset()']); ?>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label for="dis-reason" class="control-label">Disembodiment Reason&nbsp;
                                    <img ng-show="loadingReason" src="<?php echo e(asset('dist/img/facebook.gif')); ?>"
                                         width="16"></label>
                                <select ng-disabled="loadingReason" name="reason" id="dis-reason" class="form-control">
                                    <option value="">--<?php echo app('translator')->get('title.reason'); ?>--</option>
