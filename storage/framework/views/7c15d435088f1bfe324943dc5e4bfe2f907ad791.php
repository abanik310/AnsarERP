        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                ...
                <span class="info-box-icon">
                    <img src="<?php echo e(asset('dist/img/free.png')); ?>">
                </span>
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/free_ansar"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php if(Auth::user()->type==22): ?> <?php echo app('translator')->get('title.tfd'); ?> <?php else: ?> <?php echo app('translator')->get('title.tfrr'); ?> <?php endif; ?></span>
            ...
            <div class="col-md-3 line-bar-middle col-sm-6 col-xs-12">
                <div class="info-box bg-aqua">
                    <span class="info-box-icon"><img src="<?php echo e(asset('dist/img/queue.png')); ?>"></span>
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/paneled_ansar"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php if(Auth::user()->type==22): ?> <?php echo app('translator')->get('title.tpd'); ?> <?php else: ?> <?php echo app('translator')->get('title.tpr'); ?> <?php endif; ?></span>
            ...
            <div class="col-md-3 line-bar-middle col-sm-6 col-xs-12">
                <div class="info-box bg-aqua">
                    <span class="info-box-icon"><img src="<?php echo e(asset('dist/img/embodiment2.png')); ?>"></span>
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/own_embodied_ansar"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php if(Auth::user()->type==22): ?> <?php echo app('translator')->get('title.teo'); ?> <?php else: ?> <?php echo app('translator')->get('title.teor'); ?> <?php endif; ?></span>
                        ...
                        <a href="<?php echo e(URL::to('HRM/show_recent_ansar_list')); ?>/own_embodied_ansar"
                           style="color:#FFFFFF" class="btn-link">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-aqua">
                    <span class="info-box-icon"><img src="<?php echo e(asset('dist/img/ansars.png')); ?>"></span>
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/all_ansar" class="btn-link"
                           style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php if(Auth::user()->type==22): ?> <?php echo app('translator')->get('title.tad'); ?> <?php else: ?> <?php echo app('translator')->get('title.tar'); ?> <?php endif; ?></span>
                        ...
                        <a href="<?php echo e(URL::to('HRM/show_recent_ansar_list')); ?>/all_ansar" style="color:#FFFFFF"
                           class="btn-link">
            ...
            <div class="col-md-3 line-bar-middle col-sm-6 col-xs-12">
                <div class="info-box bg-aqua">
                    <span class="info-box-icon">
                        <img src="<?php echo e(asset('dist/img/embodiment2.png')); ?>">
                    </span>
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/embodied_ansar_in_different_district"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php if(Auth::user()->type==22): ?> <?php echo app('translator')->get('title.ted'); ?> <?php else: ?> <?php echo app('translator')->get('title.tedr'); ?> <?php endif; ?></span>
                        ...
                        <a href="<?php echo e(URL::to('HRM/show_recent_ansar_list')); ?>/embodied_ansar_in_different_district"
                           style="color:#FFFFFF" class="btn-link">
                ...
                <div class="info-box bg-aqua">
                    ...
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/offerred_ansar"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php if(Auth::user()->type==22): ?> <?php echo app('translator')->get('title.tod'); ?> <?php else: ?> <?php echo app('translator')->get('title.tor'); ?> <?php endif; ?></span>
                ...
                <div class="info-box bg-aqua"><span class="info-box-icon"><i class="fa fa-bed"></i></span>
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/rest_ansar"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php if(Auth::user()->type==22): ?> <?php echo app('translator')->get('title.trd'); ?> <?php else: ?> <?php echo app('translator')->get('title.trr'); ?> <?php endif; ?></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="info-box bg-aqua">
                    <span class="info-box-icon">
                        <img src="<?php echo e(asset('dist/img/freeze.png')); ?>">
                    </span>
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/freezed_ansar"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php if(Auth::user()->type==22): ?> <?php echo app('translator')->get('title.tfrd'); ?> <?php else: ?> <?php echo app('translator')->get('title.tfrrr'); ?> <?php endif; ?></span>
            ...
            <div class="col-md-3 line-bar-middle col-sm-6 col-xs-12">
                <div class="info-box bg-aqua">
                    <span class="info-box-icon"><img src="<?php echo e(asset('dist/img/freeze.png')); ?>"></span>
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/freezed_ansar_other"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php if(Auth::user()->type==22): ?> <?php echo app('translator')->get('title.tfrdo'); ?> <?php else: ?> <?php echo app('translator')->get('title.tfrrro'); ?> <?php endif; ?></span>
                        ...
                        <a href="<?php echo e(URL::to('HRM/show_recent_ansar_list')); ?>/freezed_ansar_other"
                           style="color:#FFFFFF" class="btn-link">
            ...
            <div class="col-md-3 line-bar-middle col-sm-6 col-xs-12">
                <div class="info-box bg-aqua">
                    <span class="info-box-icon"><img src="<?php echo e(asset('dist/img/blacklist.png')); ?>"></span>
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/blacked_ansar"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php if(Auth::user()->type==22): ?> <?php echo app('translator')->get('title.tbad'); ?> <?php else: ?> <?php echo app('translator')->get('title.tbar'); ?> <?php endif; ?></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="info-box bg-aqua">
                    <span class="info-box-icon"><img src="<?php echo e(asset('dist/img/blocklist.png')); ?>"></span>
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/blocked_ansar"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php if(Auth::user()->type==22): ?> <?php echo app('translator')->get('title.tbd'); ?> <?php else: ?> <?php echo app('translator')->get('title.tbr'); ?> <?php endif; ?></span>
            ...
            <div class="col-md-3 line-bar-middle col-sm-6 col-xs-12">
                <div class="info-box bg-aqua">
                    <span class="info-box-icon">
                        <img src="<?php echo e(asset('dist/img/queue.png')); ?>">
                    </span>
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/offer_block"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php echo app('translator')->get('title.tobd'); ?></span>
                ...
                <div class="info-box bg-aqua">
                    ...
                    <div class="info-box-content">
                        <a href="<?php echo e(URL::to('HRM/show_ansar_list')); ?>/retire_ansar"
                           class="btn-link" style="color: #FFFFFF !important;">
                            <span class="info-box-text"><?php echo app('translator')->get('title.tred'); ?></span>
                        ...
                        <a href="<?php echo e(URL::to('HRM/show_recent_ansar_list')); ?>/retire_ansar" style="color:#FFFFFF"
                           class="btn-link">
            ...
            <div class="col-sm-12 col-md-9 col-xs-12 pull-right">
                <div class="box box-solid">
                    ...
                    <div class="box-body" style="padding-left: 0;padding-right: 0">
                        ...
                        <div class="label-hrm-title">
                            <span class="info-box-text"
                                  style="color: #000000;white-space: normal;overflow: auto;text-overflow: initial">Total number of Vacancy in KPI</span>
                        </div>
