    ...
    <div class="login-box-body" style="background: rgba(255,255,255,.32)">
        ...
        <?php if(Session::has('error')): ?>
            <p class="text text-danger"
               style="text-align: center;text-transform: uppercase;font-weight: bold;background-color: #FFFFFF;"><?php echo e(Session::get('error')); ?></p>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <form action="<?php echo e(URL::route('otp_password_request_handle')); ?>" method="post">
		...
		<div style="margin-top:10px;">
		    <button id='btn_resend' data-id="<?php echo e(Session::get('user_id')); ?>"> Resend OTP </button>
...
<script>
 ...
 $( document ).ready(function() {
    $('#btn_resend').on('click', function (event) {
		...
		var password = '<?php echo e(Session::get('password')); ?>';
		password = encodeURIComponent(password);
		
		$.ajax({ 
			type: "POST", 
			url: "<?php echo e(URL::to('check_resendotp')); ?>", 
			data: {
				//"user_name": '<?php echo e(Session::get('user_name')); ?>',
				"user_id": userId,
