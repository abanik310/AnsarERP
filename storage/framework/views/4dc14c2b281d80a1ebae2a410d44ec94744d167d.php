<?php $__env->startSection('title','Search Applicant'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('recruitment.applicant.search'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        GlobalApp.controller('applicantSearch', function ($rootScope,$scope, $http, $q, httpService, $sce,notificationService) {
            ...
            var loadAll = function () {
                ...
                $q.all([
                    ...
                    $http.get("<?php echo e(URL::to('HRM/getalleducation')); ?>")
                ])
            ...
            $scope.selectApplicants = function (type,subType) {
                $scope.allLoading = true;
                $http({
                    url:'<?php echo e(URL::route('recruitment.applicant.confirm_selection_or_rejection')); ?>',
                    method:'post',
                    data:{
            ...
            $scope.acceptedAsSpecial = function (id) {
                ...
                $http({
                    ...
                    url:'<?php echo e(URL::route("recruitment.applicant.confirm_accepted_special_candidate")); ?>'
                }).then(function (response) {
        ...
        GlobalApp.controller('fullEntryFormController', function ($scope, $q, $http, httpService, notificationService,$rootScope) {
            ...
            $scope.loadApplicantDetail = function () {
                $q.all([
                    $http({method: 'get', url: '<?php echo e(URL::to('recruitment/applicant/detail')); ?>/'+$rootScope.applicant_id}),
                    httpService.range(),
                    httpService.education(),
                    $http({method: 'get', url: '<?php echo e(URL::route('recruitment.applicant.getfieldstore')); ?>'})
                ]).then(function (response) {
                    //console.log(response)
                    $scope.allLoading = false;
            ...
            $scope.updateData = function () {
                ...
                $http({
                    method: 'post',
                    data: $scope.formData,
                    url: '<?php echo e(URL::route('recruitment.applicant.update')); ?>'
                }).then(function (response) {
                    $scope.allLoading = false;
                    notificationService.notify(response.data.status, response.data.message)
    ...
    <section class="content" ng-controller="applicantSearch">
        ...
        <?php /*<div class="modal fade" id="filter-list">
