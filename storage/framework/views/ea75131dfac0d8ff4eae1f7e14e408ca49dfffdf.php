<?php $__env->startSection('title','Exam Center'); ?>
<?php $__env->startSection('small_title'); ?>
    <a href="<?php echo e(URL::route('recruitment.exam-center.create')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-clipboard"></i>&nbsp;Add New Exam Center</a>
    <?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('recruitment.setting.exam_center'); ?>
