...
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('dashboard_menu_recent',$pageTitle,$type); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <script>
        GlobalApp.controller('AnsarListController', function ($scope, $http, $sce, httpService) {
            $scope.ansarType = '<?php echo e($type); ?>';
            $scope.queue = [];
            $scope.rank = 'all';
            $scope.param = {};
            ...
            $scope.loadPage = function (page, $event) {
                ...
                $http({
                    url: '<?php echo e(URL::route('get_recent_ansar_list')); ?>',
                    method: 'get',
                    params: {
    ...
    <div ng-controller="AnsarListController">
        <section class="content">
            <div class="box box-solid">
                ...
                <div class="box-body">
                    <?php if($pageTitle=="Total Paneled Ansars (Recent)"): ?>
                        <filter-template
                    ...
                    <div class="table-responsive">
                        <template-list data="ansars" key="<?php echo e($type); ?>"></template-list>
                    </div>
                    <div class="row">
                        <div class="col-sm-4">
