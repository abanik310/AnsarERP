        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a href="<?php echo e(URL::to('/HRM/show_available_unit_company_ansar_list')); ?>">
                            <i class="fa fa-users"></i>
                            <span>Unit Company Wise Ansars</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(URL::to('/HRM/show_pending_unit_company_ansar_list')); ?>">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
					...
					<?php if((auth()->user()->type ==11) || (auth()->user()->type ==66) ||(auth()->user()->id == 348)): ?>
