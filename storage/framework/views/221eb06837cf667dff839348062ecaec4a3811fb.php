<?php $__env->startSection('title','Ansar Transfer History'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('transfer_ansar_history'); ?>
    ...
    <script>
        GlobalApp.controller('TransferController', function ($scope,$http) {
            ...
            $scope.loadTransferHistory = function (ansar_id) {
                ...
                $http({
                    url:'<?php echo e(URL::route('get_transfer_ansar_history')); ?>',
                    method:'get',
