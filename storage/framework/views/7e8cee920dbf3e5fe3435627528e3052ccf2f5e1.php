...
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('panel_information'); ?>
    ...
    <script>
        GlobalApp.controller("PanelController", function ($scope, $http, notificationService) {
            ...
            $scope.loadForPanel = function () {
                ...
                $http({
                    url: '<?php echo e(URL::route('select_status')); ?>',
                    method: 'get',
            ...
            $scope.submitPanelEntry = function () {
                ...
                $http({
                    url: '<?php echo e(URL::route('save-panel-entry')); ?>',
                    method: 'post',
...
//                        $scope.alerts.push({type:'error',message:$scope.result.message})
    ...
    <div ng-controller="PanelController">
        ...
        <?php /*<?php echo Breadcrumbs::render('panel_information'); ?>*/ ?>
        <?php /*</div>*/ ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="pc-table">
                                    ...
                                    <tr>
                                        ...
                                        <?php /*<th><input type="checkbox" id="select-all-panel" name="" value=""*/ ?>
                                        <?php /*style="height: 20px; width: 25px"> Select All*/ ?>
                                        <?php /*</th>*/ ?>
                                    </tr>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo Form::text('panel_date', $value = null, $attributes = array('class' => 'form-control','date-picker'=>'moment().format("DD-MMM-YYYY HH:mm:ss")', 'id' => 'panel_date', 'ng_model' => 'submitEntryPanelData.panel_date','placeholder'=>'Panel Date', 'required','add-time'=>1)); ?>
