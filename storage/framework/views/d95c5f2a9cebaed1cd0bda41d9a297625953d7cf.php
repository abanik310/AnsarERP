<?php $__env->startSection('title','Disembodiment'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('disembodiment_entry'); ?>
...
<?php $__env->startSection('content'); ?>
    <script>
        ...
        GlobalApp.controller('NewDisembodimentController', function ($scope, $http, notificationService) {
            ...
            $scope.loadAnsar = function () {
                ...
                $http({
                    url: '<?php echo e(URL::route('load_ansar')); ?>',
                    method: 'get',
                    params: $scope.param
            ...
            $scope.showFormData = function () {
                ...
                $http({
                    url: '<?php echo e(URL::to('HRM/disembodiment-entry')); ?>',
                    method: 'post',
                    data: angular.toJson({
    ...
    <div ng-controller="NewDisembodimentController">
        ...
        <section class="content">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php echo Form::text('disembodiment_date', $value = null, $attributes = array('class' => 'form-control', 'id' => 'disembodiment_date',  'ng-model'=> 'disembodiment_date', 'disabled')); ?>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php echo Form::text('disembodiment_comment', $value = null, $attributes = array('class' => 'form-control', 'id' => 'disembodiment_comment', 'ng-model'=> 'disembodiment_comment', 'placeholder'=> 'Write Comment')); ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <?php echo Form::open(['route'=>'print_letter','target'=>'_blank','ng-if'=>'printLetter','class'=>'pull-left']); ?>

                    <?php echo Form::hidden('option','memorandumNo'); ?>

                    <?php echo Form::hidden('id','[[memorandumId]]'); ?>

                    <?php echo Form::hidden('type','DISEMBODIMENT'); ?>

                    <?php if(auth()->user()->type!=22): ?>
                        <?php echo Form::hidden('unit','[[newParam.unit]]'); ?>
