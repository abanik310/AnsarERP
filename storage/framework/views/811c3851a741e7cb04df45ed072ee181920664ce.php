<?php $__env->startSection('title','Embodiment Day Based Ansar Info'); ?>
    ...
    <script>
        GlobalApp.controller('EmbodimentCountReportController', function ($scope, $http, $sce) {
            ...
            $scope.loadPage = function (page, $event) {
                ...
                $http({
                    url: '<?php echo e(URL::route('embodiment_count_details')); ?>',
                    method: 'get',
                    params: {   
            ...
            $scope.exportData = function (type) {
                ...
                $http({
                    url: '<?php echo e(URL::route('blocklisted_ansar_info')); ?>',
                    method: 'get',
                    params: {
