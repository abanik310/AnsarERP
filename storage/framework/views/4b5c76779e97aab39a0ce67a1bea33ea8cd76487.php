<?php $__env->startSection('title','Edit Ansar Information'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('entry_edit',$ansarAllDetails->ansar_id); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        GlobalApp.controller('fullEntryFormController', function ($scope, getNameService, getBloodService, getDiseaseSkillService, $sce, $http) {
            ...
            $scope.bank_name='<?php echo e($ansarAllDetails->account?$ansarAllDetails->account->bank_name:""); ?>'
            $scope.prefer_choice='<?php echo e($ansarAllDetails->account?$ansarAllDetails->account->prefer_choice:""); ?>'
            $scope.mobile_bank_type='<?php echo e($ansarAllDetails->account?$ansarAllDetails->account->mobile_bank_type:""); ?>'
            ...
            $scope.recent_status = "<?php echo e($ansarAllDetails->designation_id); ?>";
            $scope.marital_status = "<?php echo e($ansarAllDetails->marital_status); ?>";
            $scope.particular_skill = "<?php echo e($ansarAllDetails->skill_id); ?>";
            if ($scope.particular_skill == 1) {
                $scope.own_particular_skill = true;
            }
            $scope.long_term_disease = "<?php echo e($ansarAllDetails->disease_id); ?>";
            if ($scope.long_term_disease == 1) {
                $scope.own_disease = true;
            }
            $scope.selectedSession = "<?php echo e($ansarAllDetails->session_id); ?>";
            ...
            $scope.SelectedDivision = "<?php echo e($ansarAllDetails->division_id); ?>";
            ...
            $scope.SelectedDistrict = "<?php echo e($ansarAllDetails->unit_id); ?>";
            ...
            $scope.ThanaModel = "<?php echo e($ansarAllDetails->thana_id); ?>";
            ...
            $scope.BloodModel = "<?php echo e($ansarAllDetails->blood_group_id); ?>";
            $scope.sex = "<?php echo e($ansarAllDetails->sex); ?>";
            ...
            <?php $__empty_1 = true; foreach($ansarAllDetails->education as $edu): $__empty_1 = false; ?>
                <?php if($edu->educationName): ?> $scope.ppp.educationIdBng.push('<?php echo e($edu->educationName->id); ?>');
            <?php endif; ?>

                   $scope.eduRows.push([

                        {text: "শিক্ষা প্রতিষ্ঠানের নাম", value: '<?php echo e($edu->institute_name); ?>', name: 'institute_name[]'},
                        {text: "Passing year", value: '<?php echo e($edu->passing_year); ?>', name: 'passing_year[]'},
                        {text: "বিভাগ / শ্রেণী", value: '<?php echo e($edu->gade_divission); ?>', name: 'gade_divission[]'},
                    ]);
            $scope.eduEngRows.push([
                {text: "Institute Name", value: '<?php echo e($edu->institute_name_eng); ?>', name: 'institute_name_eng[]'},
                {text: "Passing year", value: '<?php echo e($edu->passing_year_eng); ?>', name: 'passing_year_eng[]'},
                {text: "Class", value: '<?php echo e($edu->gade_divission_eng); ?>', name: 'gade_divission_eng[]'},
            ]);
            ...
            <?php $__empty_1 = true; foreach($ansarAllDetails->training as $training): $__empty_1 = false; ?>
                $scope.ppp.training.push('<?php echo e($training->training_designation); ?>')
                $scope.trainingRows.push([
                        {
                            text: "পদবী",
                            value: '<?php echo e($training->training_designation); ?>',
                        ...
                        {
                            text: "প্রতিষ্ঠান",
                            value: '<?php echo e($training->training_institute_name); ?>',
                            name: 'institute[]',
                            type: 'text',
                            class_name: ''
                        },
                        {
                            text: "Training start date",
                            value: '<?php echo e($training->training_start_date); ?>',
                            name: 'training_start[]',
                            type: '',
                            class_name: 'date-picker-dir'
                        },
                        {
                            text: "Training end date",
                            value: '<?php echo e($training->training_end_date); ?>',
                            name: 'training_end[]',
                            type: '',
                            class_name: 'date-picker-dir'
                        },
                        {
                            text: "আপ/আম নম্বর",
                            value: '<?php echo e($training->trining_certificate_no); ?>',
                            name: 'training_sanad[]',
                            type: 'text',
                            class_name: ''
                        }
            ...
            $scope.trainingEngRows.push([
                ...
                {
                    text: "Institute",
                    value: '<?php echo e($training->training_institute_name_eng); ?>',
                    name: 'institute_eng[]',
                    type: 'text'
                },
                {
                    text: "Training start date",
                    value: '<?php echo e($training->training_start_date_eng); ?>',
                    name: 'training_start_eng[]',
                    type: '',
                    class_name: 'date-picker-dir'
                },
                {
                    text: "Training end date",
                    value: '<?php echo e($training->training_end_date_eng); ?>',
                    name: 'training_end_eng[]',
                    type: '',
                    class_name: 'date-picker-dir'
                },
                {
                    text: "আপ/আম নম্বর",
                    value: '<?php echo e($training->trining_certificate_no_eng); ?>',
            ...
            <?php $__empty_1 = true; foreach($ansarAllDetails->nominee as $nominee): $__empty_1 = false; ?>
            $scope.nomineeRows.push([
                        {text: "নাম", value: '<?php echo e($nominee->name_of_nominee); ?>', name: 'nominee_name[]'},
                        {text: "সম্পর্ক", value: '<?php echo e($nominee->relation_with_nominee); ?>', name: 'relation[]'},
                        {text: "Percentage", value: '<?php echo e($nominee->nominee_parcentage); ?>', name: 'percentage[]'},
                        {text: "মোবাইল নং", value: '<?php echo e($nominee->nominee_contact_no); ?>', name: 'nominee_mobile[]'}
                    ]);
            $scope.nomineeEngRows.push([
                {text: "Name", value: '<?php echo e($nominee->name_of_nominee_eng); ?>', name: 'nominee_name_eng[]'},
                {text: "Relation", value: '<?php echo e($nominee->relation_with_nominee_eng); ?>', name: 'relation_eng[]'},
                {text: "Percentage", value: '<?php echo e($nominee->nominee_parcentage_eng); ?>', name: 'percentage_eng[]'},
                {text: "Mobile no", value: '<?php echo e($nominee->nominee_contact_no_eng); ?>', name: 'nominee_mobile_eng[]'}
            ]);
            <?php endforeach; if ($__empty_1): ?>
...
//        $scope.addNomineeinput();
        ...
        GlobalApp.factory('getNameService', function ($http) {
            return {
                ...
                getSession: function () {
                    return $http.get("<?php echo e(URL::to('HRM/SessionName')); ?>");
                }
            }
...
//                                    alert(min)
                                ...
                                if (scope.formSubmitResult.status == true) {
                                    window.location = "<?php echo e(URL::to('HRM/entrylist')); ?>";
                                }
    ...
    <div id="entryform" ng-controller="fullEntryFormController" d-picker>
        ...
        <div>
            <?php /*<div class="breadcrumbplace">*/ ?>
                <?php /*<?php echo Breadcrumbs::render('editentryform'); ?>*/ ?>
            <?php /*</div>*/ ?>
                    ...
                    <div style="padding: 10px 20px">
                        ...
                        <div id="entryform">
                            <form id="pppp" class="form-horizontal" enctype="multipart/form-data" id="myForm"
                                  method="post" action="<?php echo e(URL::route('submiteditentry')); ?>">
                                <?php echo csrf_field(); ?>
                                            ...
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control "
                                                           value="<?php echo e($ansarAllDetails->ansar_id); ?>" disabled/>
                                                </div>
                                            ...
                                            <div class="form-horizontal col-md-12" ng-show="isAdmin==55">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select name="session_id" ng-model="selectedSession"
                                                            ...
                                                            value="<?php echo e(Request::old('selectedSession')); ?>">
                                            ...
                                            <div class="form group col-md-12"
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control " name="ansar_name_eng"
                                                           value="<?php echo e($ansarAllDetails->ansar_name_eng); ?>"
                                            ...
                                            <div class="form-horizontal col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="ansar_name_bng"
                                                           name="ansar_name_bng"
                                                           value="<?php echo e($ansarAllDetails->ansar_name_bng); ?>"
                                            ...
                                            <div class="form group col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" id="father_name_eng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->father_name_eng); ?>" type="text"
                                            ...
                                            <div class="form group col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control " id="father_name_bng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->father_name_bng); ?>" type="text"
                                            ...
                                            <div class="form group col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="mother_name_eng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->mother_name_eng); ?>">
                                                    <span style="color:red"
                                            ...
                                            <div class="form group col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="mother_name_bng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->mother_name_bng); ?>">
                                                    <span style="color:red"
                                            ...
                                            <div class="form group col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control picker " id="data_of_birth"
                                                           name="data_of_birth" date-picker="moment('<?php echo e($ansarAllDetails->data_of_birth); ?>').format('DD-MMM-YYYY')"
                                                           placeholder="Date of birth"
                                                           value="<?php echo e($ansarAllDetails->data_of_birth); ?>">
                                                    <span style="color:red"
                                            ...
                                            <div class="form group col-md-12 ">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="spouse_name_eng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->spouse_name_eng); ?>">
                                            ...
                                            <div class="form group col-md-12 ">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="spouse_name_bng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->spouse_name_bng); ?>">
                                                </div>
                                            </div>
                                            <div class="form group col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="national_id_no"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->national_id_no); ?>">
                                                    <span style="color:red"
                                            ...
                                            <div class="form group col-md-12 ">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="birth_certificate_no"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->birth_certificate_no); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-horizontal col-md-12 " ng-show="own_disease">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" id="own_disease" name="own_disease"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->own_disease); ?>"
                                            ...
                                            <div class="form-horizontal col-md-12 " ng-show="own_particular_skill">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control"
                                                           value="<?php echo e($ansarAllDetails->own_particular_skill); ?>"
                                            ...
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " name="criminal_case" type="text"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->criminal_case); ?>">
                                            ...
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " name="criminal_case_bng" type="text"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->criminal_case_bng); ?>">

                                                </div>
                                            </div>
                                            <?php /*<div class="form group col-md-12">*/ ?>
                                                <?php /*<label class="control-label col-sm-2" for="criminal">সর্বশেষ প্রশিক্ষন*/ ?>
                                                    <?php /*সনদ নং:</label>*/ ?>

                                                <?php /*<div class="col-sm-10">*/ ?>
                                                    <?php /*<input class="form-control  " id="certificate_no"*/ ?>
                                                           <?php /*name="certificate_no" type="text"*/ ?>
                                                           <?php /*placeholder="সর্বশেষ প্রশিক্ষন সনদ নং"*/ ?>
                                                           <?php /*value="<?php echo e($ansarAllDetails->certificate_no); ?>">*/ ?>
                                                <?php /*</div>*/ ?>
                                            <?php /*</div>*/ ?>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="village_name" name="village_name"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->village_name); ?>">
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="village_name_bng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->village_name_bng); ?>">
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="post_office_name"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->post_office_name); ?>">
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="post_office_name_bng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->post_office_name_bng); ?>">
                                            ...
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="union_name_eng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->union_name_eng); ?>">
                                                </div>
                                            </div>
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" id="union_name_bng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->union_name_bng); ?>">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select ng-disabled="disbaleDDT" name="thana_name_eng" class="form-control" id="sell"
                                                        ...
                                                        <option ng-repeat="x in thana"
                                                                ng-selected="x.id=='<?php echo e(Request::old('thana_name_eng')); ?>'"
                                            ...
                                            <div class="form-horizontal col-md-12 "
                                                ...
                                                <div class="col-sm-5">
                                                    <input class="form-control  " id="hight_feet" name="hight_feet"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->hight_feet); ?>">
                                                    <span style="color:red"
                                                          ng-show="formSubmitResult.error.hight_feet[0]">[[ formSubmitResult.error.hight_feet[0] ]]</span>
                                                </div>
                                                <div class="col-sm-5">
                                                    <input class="form-control" ng-init="hight_inch=<?php echo e($ansarAllDetails->hight_inch); ?>" ng-model="hight_inch" ng-change="hight_inch=hight_inch>=12?11:hight_inch" id="hight_inch" name="hight_inch" type="text" placeholder=" INCHES" value="<?php echo e($ansarAllDetails->hight_inch); ?>">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select name="blood_group_name_bng" class="form-control" id="sell"
                                                        ...
                                                        <option ng-repeat="x in blood"
                                                                ng-selected="x.id=='<?php echo e(Request::old('blood_group_name_bng')); ?>'"
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="eye_color" name="eye_color"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->eye_color); ?>">
                                                </div>
                                            </div>
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="eye_color" name="eye_color_bng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->eye_color_bng); ?>">
                                                </div>
                                            </div>
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="skin_color" name="skin_color"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->skin_color); ?>">
                                                </div>
                                            </div>
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="skin_color_bng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->skin_color_bng); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="identification_mark"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->identification_mark); ?>">
                                                </div>
                                            </div>
                                            <div class="form group col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="identification_mark_bng"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->identification_mark_bng); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <input type="hidden" name="ansar_id" value="<?php echo e($ansarAllDetails->ansar_id); ?>">
                                        ...
                                        <div class="box-body">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select name="bank_name" class="form-control" id="sell"
                                                        ...
                                                        <option ng-repeat="x in bankList"
                                                                ng-selected="x=='<?php echo e(Request::old('bank_name')); ?>'"
                                                                value="[[x]]">[[x]]
                                                        </option>
                                                    </select>
                                                    <span style="color:red"
                                            ...
                                            <div class="form-horizontal col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="branch_name"
                                                           name="branch_name"
                                                           value="<?php echo e($ansarAllDetails->account?$ansarAllDetails->account->branch_name:''); ?>"
                                            ...
                                            <div class="form-horizontal col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="branch_name"
                                                           name="account_no"
                                                           value="<?php echo e($ansarAllDetails->account?$ansarAllDetails->account->account_no:''); ?>"
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select name="mobile_bank_type" class="form-control" id="sell"
                                                        ...
                                                        <option ng-repeat="x in mobileBankType"
                                                                ng-selected="x=='<?php echo e(Request::old('mobile_bank_type')); ?>'"
                                                                value="[[x]]">[[x]]
                                                        </option>
                                                    </select>
                                                    <span style="color:red"
                                            ...
                                            <div class="form-horizontal col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="branch_name"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->account?$ansarAllDetails->account->mobile_bank_account_no:''); ?>"
                                                           placeholder="ব্যাংক অ্যাকাউন্ট নম্বর"/>
                                                    <span style="color:red"
                                            ...
                                            <div class="form-horizontal col-md-12 ">
                                                ...
                                                <div class="col-sm-10 ">
                                                    <select name="prefer_choice" class="form-control" id="sell"
                                                            ng-model="prefer_choice" value="<?php echo e($ansarAllDetails->account?$ansarAllDetails->account->prefer_choice:''); ?>">
                                                        <option value="">--নির্বাচন করুন--</option>
                                    ...
                                    <div class="box-info">
                                        <div class="box-body">
                                            <div class="form-horizontal col-md-12 "
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group" ng-init="mobile_no_self='<?php echo e($ansarAllDetails->mobile_no_self); ?>'">
                                                        ...
                                                        <input class="form-control  " id="mobile_no_self"
                                                               ...
                                                               value="<?php echo e($ansarAllDetails->mobile_no_self); ?>">
                                                    </div>
                                                    <span style="color:red"
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="mobile_no_request"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->mobile_no_request); ?>">
                                                </div>
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="land_phone_self"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->land_phone_self); ?>">
                                                </div>
                                            </div>
                                            <div class="form group col-md-12">
                                                <label class="control-label col-sm-2" for="email">Land phone
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="land_phone_request"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->land_phone_request); ?>">
                                                </div>
                                            </div>
                                            <div class="form-horizontal col-md-12 ">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="email_self" name="email_self"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->email_self); ?>">
                                                </div>
                                            ...
                                            <div class="form-horizontal col-md-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control  " id="email_request"
                                                           ...
                                                           value="<?php echo e($ansarAllDetails->email_request); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <input type="hidden" name="ID" value="<?php echo e($ansarAllDetails->ansar_id); ?>"/>
