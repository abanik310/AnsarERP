<?php $__env->startSection('title','Embodied Ansar Report'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('embodiment_report_view'); ?>
...
<?php $__env->startSection('content'); ?>
    <script>
        GlobalApp.controller('ReportAnsarEmbodiment', function ($scope, $http, $sce) {
            $scope.total = 0;
            $scope.numOfPage = 0;
            $scope.param = {limit: parseInt("<?php echo e(config('app.item_per_page')); ?>") + ''};
            ...
            $scope.loadPage = function (page, $event) {
                ...
                $http({
                    url: '<?php echo e(URL::route('emboded_ansar_info')); ?>',
                    method: 'get',
                    params: {
