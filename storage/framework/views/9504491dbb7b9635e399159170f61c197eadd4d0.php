...
<head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="<?php echo e(asset('dist/css/id-card.css')); ?>">
...
<div id="ansar-id-card-front" style="font-family: 'Times New Roman',sans-serif" >
    ...
    <div class="card-header">
        <div class="card-header-left-part">
            <img src="<?php echo e(asset('dist/img/idlogo.png')); ?>" class="img-responsive">
        </div>
        <div class="card-header-right-part">
            <h4 style="<?php if($type=='bng'): ?> font-size: 1em <?php elseif($type=='eng'): ?> font-size:1em; <?php endif; ?>"><?php echo e($rd['title']); ?></h4>
            <h5 style="font-size: 13px"><?php echo e($rd['id_no']); ?>
    ...
    <div class="card-body">
        ...
        <img src="data:image/png;base64,<?php echo e(DNS2D::getBarcodePNG(GlobalParameter::generateSmartCard($ad->unit_code,$ad->ansar_id).'%0DRintu Chowdhury','QRCODE')); ?>"
        ...
        <div class="card-body-left">
            <ul>
                ...
                <li><?php echo e($rd['bg']); ?><span class="pull-right">:</span></li>
                <li><?php echo e($rd['unit']); ?><span class="pull-right">:</span></li>
                <li><?php echo e($rd['id']); ?><span class="pull-right">:</span></li>
                <li><?php echo e($rd['ed']); ?><span class="pull-right">:</span></li>
            </ul>
        </div>
        <div class="card-body-middle">
            <ul>
                ...
                <li><?php echo e($ad->blood_group); ?></li>
                <li><?php echo e($ad->unit_name); ?></li>
                <li><?php echo e(strcasecmp($type,'bng')==0?LanguageConverter::engToBng($id):$id); ?></li>
                <li><?php echo e(strcasecmp($type,'bng')==0?LanguageConverter::engToBng($ed):$ed); ?></li>
            </ul>
        </div>
        <div class="card-body-right">
            <img src="<?php echo e(URL::to('/image').'?file='.$ad->profile_pic); ?>"
                  style="width: 76px;height: 100px">
        </div>
    </div>
    <div class="card-footer" style="margin-top: 2px">
        <div class="card-footer-sing">
            <div><img src="<?php echo e(URL::to('/image').'?file='.$ad->sign_pic); ?>"
                      style="width: 80px;height:30px"></div>
            <div><?php echo e($rd['bs']); ?></div>
        </div>
        <div class="card-footer-barcode">
            <img src="data:image/png;base64,<?php echo e(DNS1D::getBarcodePNG(GlobalParameter::generateSmartCard($ad->unit_code,$ad->ansar_id),'C128')); ?>"
                 style="max-width: 100%">
        </div>
        <div class="card-footer-sing" style="float: right">
            <div><img src="<?php echo e(URL::to('/image').'?file=data/authority/Signature.jpg'); ?>"
                      style="width: 80px;height:30px"></div>
            <div><?php echo e($rd['is']); ?></div>
        </div>
    </div>
    <h5 style="text-align: center;margin-top: 0;font-size: 12px;background: limegreen"><?php echo e($rd['footer_title']); ?></h5>
</div>
<div>
