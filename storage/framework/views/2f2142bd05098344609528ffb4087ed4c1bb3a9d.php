...
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('attendance.create'); ?>
...
<caption><span style="font-size: 20px;">Total Payment()</span>
            <a href="<?php echo e(URL::route('SD.kpi_payment.create')); ?>" class="btn btn-primary btn-xs pull-right">
        ...
        <tr>
            ...
            $scope.loadPage = function (url) {
                ...
                $http({
                    method: 'get',
                    url: url||"<?php echo e(URL::route('SD.kpi_payment.index')); ?>",
                    params: $scope.param,
