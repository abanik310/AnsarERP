...
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('new_kpi'); ?>
...
<?php $__env->startSection('content'); ?>
    <script>
        ...
        GlobalApp.controller('DivisionController', function ($scope, getNameService) {
            ...
            <?php if(!is_null(Request::old('division_name_eng'))): ?>
            $scope.SelectedDivision = parseInt('<?php echo e(Request::old('division_name_eng')); ?>');
            $scope.SelectedItemChanged();
            <?php endif; ?>

                <?php if(!is_null(Request::old('unit_name_eng'))): ?>
                $scope.SelectedDistrict = parseInt('<?php echo e(Request::old('unit_name_eng')); ?>');
    ...
    <div style="position: relative; padding-bottom: 30px">
        <?php echo Form::open(array('route' => 'save-kpi', 'class' => 'form-horizontal', 'name' => 'kpiForm', 'id'=> 'kpi-form', 'ng-controller' => 'DivisionController', 'ng-app' => 'myValidateApp', 'novalidate')); ?>
        ...
        <section class="content">
            <div class="row">
                <div class="col-lg-8 col-centered">
                                    ...
                                    <div id="kpi_general" class="tab-pane fade in active">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <?php echo Form::textarea('kpi_address', $value = null, $attributes = array('class' => 'form-control', 'id' => 'kpi_address', 'size' => '30x4', 'placeholder' => "Write the Address")); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <?php echo Form::textarea('kpi_contact_no', $value = null, $attributes = array('class' => 'form-control', 'id' => 'kpi_contact_no', 'size' => '30x4', 'placeholder' => "Write Contact No. and Person Info")); ?>
                                            ...
                                            <div class="box-body">
                                                <div class="form-group required">
                                                    ...
                                                    <div class="col-sm-8"
                                                        ...
                                                        <?php echo Form::text('total_ansar_request', $value = null, $attributes = array('class' => 'form-control', 'id' => 'total_ansar_request', 'placeholder' => 'Enter Total Ansar Request Number', 'required', 'ng-model' => 'total_ansar_request','numeric-field')); ?>
                                                ...
                                                <div class="form-group required">
                                                    ...
                                                    <div class="col-sm-8"
                                                        ...
                                                        <?php echo Form::text('total_ansar_given', $value = null, $attributes = array('class' => 'form-control', 'id' => 'total_ansar_given', 'placeholder' => 'Enter Total Ansar given Number', 'required', 'ng-model' => 'total_ansar_given','numeric-field')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <?php echo Form::text('bullet_no', $value = null, $attributes = array('class' => 'form-control', 'id' => 'bullet_no', 'placeholder' => 'Enter Number of Bullets','numeric-field')); ?>
                                                ...
                                                <div class="form-group required">
                                                    ...
                                                    <div class="col-sm-8"
                                                        ...
                                                        <?php echo Form::text('activation_date', $value = null, $attributes = array('class' => 'form-control', 'id' => 'activation_date', 'required', 'ng-model' => 'activation_date','placeholder'=>'Activation date')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <?php echo Form::text('withdraw_date', $value = null, $attributes = array('class' => 'form-control', 'id' => 'withdraw_date','placeholder'=>'Withdraw date')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <?php echo Form::text('no_of_pc', $value = null, $attributes = array('class' => 'form-control', 'id' => 'no_of_pc', 'placeholder' => 'Enter Number of PC','numeric-field')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <?php echo Form::text('no_of_apc', $value = null, $attributes = array('class' => 'form-control', 'id' => 'no_of_apc', 'placeholder' => 'Enter Number of APC','numeric-field')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <?php echo Form::text('no_of_ansar', $value = null, $attributes = array('class' => 'form-control', 'id' => 'no_of_ansar', 'placeholder' => 'Enter Number of Ansar','numeric-field')); ?>
                    ...
                    <?php /*<button style="background: #5bc0de; border-color: #46b8da; color: #FFFFFF" class="btn" id="prevtab" type="button">Prev</button>*/ ?>
                    <?php /*<button style="background: #5bc0de; border-color: #46b8da; color: #FFFFFF" class="btn" id="nexttab" type="button">Next</button>*/ ?>
                    <?php /*</div>*/ ?>
                    <?php /*<button type="submit" id="next-button" class="btn btn-info pull-right"*/ ?>
                    <?php /*ng-disabled="kpiForm.kpi_name.$error.required||kpiForm.division_name_eng.$error.required||kpiForm.unit_name_eng.$error.required||kpiForm.thana_name_eng.$error.required||kpiForm.total_ansar_request.$error.required||kpiForm.total_ansar_given.$error.required||kpiForm.with_weapon.$error.required||kpiForm.activation_date.$error.required">*/ ?>
                    <?php /*Save KPI Information*/ ?>
                    <?php /*</button>*/ ?>
                    <?php echo Form::close(); ?>
