<?php $__env->startSection('title','Circular Summery'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('recruitment.applicant.index'); ?>
    ...
    <script>
        GlobalApp.controller('circularSummery', function ($scope, $http, $q, httpService) {
            ...
            var loadAll = function () {
                ...
                $scope.category = '<?php echo e(Request::get('category')); ?>';
                <?php else: ?>
                    $scope.category = 'all';
                <?php endif; ?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr ng-repeat="a in circularSummery">
                            ...
                            <td><a href="<?php echo e(URL::to('recruitment/applicants/list')); ?>/[[a.id]]" class="btn btn-link">[[a.id>=27?(a.appliciant_count-a.appliciant_paid_not_apply_count)+divide(a.appliciant_paid_not_apply_count,10):a.appliciant_count]]</a>
                            </td>
                            <td><a href="<?php echo e(URL::to('recruitment/applicants/list')); ?>/[[a.id]]/Male" class="btn btn-link">[[a.appliciant_male_count]]</a>
                            </td>
                            <td><a href="<?php echo e(URL::to('recruitment/applicants/list')); ?>/[[a.id]]/Female"
                                   class="btn btn-link">[[a.appliciant_female_count]]</a></td>
                            <td><a href="<?php echo e(URL::to('recruitment/applicants/list')); ?>/[[a.id]]/initial"
                                   class="btn btn-link">[[+a.appliciant_initial_count+ +a.appliciant_not_paid_count]]</a>
                            </td>
                            <td><a href="<?php echo e(URL::to('recruitment/applicants/list')); ?>/[[a.id]]/paid" class="btn btn-link">[[a.id>=27?divide(a.appliciant_paid_not_apply_count,10):a.appliciant_paid_not_apply_count]]</a>
                            </td>
                            <td><a href="<?php echo e(URL::to('recruitment/applicants/list')); ?>/[[a.id]]/applied"
