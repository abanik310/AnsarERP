<?php $__env->startSection('title','Direct Transfer'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('direct_transfer'); ?>
    ...
    <script>
        GlobalApp.controller('DirectTransferController', function ($scope, $http, $sce) {
            ...
            $scope.loadAnsarDetail = function (id) {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::to('HRM/single_embodied_ansar_detail')); ?>/' + id
        ...
        <section class="content" style="position: relative;">
            <div class="box box-solid">
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-4">
                            <?php echo Form::open(['route'=>'direct_transfer_submit','form-submit','errors','loading'=>'loadingSubmit','on-reset'=>'reset()']); ?>
