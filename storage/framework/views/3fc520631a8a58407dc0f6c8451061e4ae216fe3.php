...
<?php $__env->startSection('title','Cancel KPI Withdrawal'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('kpi_withdraw_cancel'); ?>
    ...
    <script>
        GlobalApp.controller('KpiWithdrawCancelController', function ($scope, $http, $sce, httpService, notificationService) {
            ...
            $scope.loadPage = function (page, $event) {
                ...
                $http({
                    url: '<?php echo e(URL::route('inactive_kpi_list')); ?>',
                    method: 'get',
                    params: {
...
//                    $compile($scope.ansars)
            ...
            $scope.verify = function (id, i) {
                ...
                $http({
                    url: "<?php echo e(URL::to('HRM/active_kpi')); ?>/" + id,
                    data: {verified_id: id},
                    method: 'post'
                }).then(function (response) {
...
//                    $scope.verified++;
            ...
            $scope.cancelWithdraw = function (id) {
                ...
                $http({
                    url: "<?php echo e(URL::to('HRM/kpi-withdraw-cancel-update')); ?>/" + id,
                    data: {kpi_id: id},
                    method: 'post'
                }).then(function (response) {
...
//                console.log($scope.formData)
                $scope.error = undefined;
                $http({
                    url: "<?php echo e(URL::to('HRM/withdraw-date-update')); ?>/" + id,
