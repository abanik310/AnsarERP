<?php $__env->startSection('title','Rejected Offer List'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('rejected_offer_list'); ?>
        ...
        GlobalApp.controller('ReportGuardSearchController', function ($scope, $http,notificationService) {
            ...
            $scope.getRejectedAnsarList = function () {
                ...
                $http({
                    ...
                    url:'<?php echo e(URL::to('HRM/get_rejected_ansar_list')); ?>'
...
//                return;
                ...
                $http({
                    method:'post',
                    url:"<?php echo e(URL::route('blocklist_entry')); ?>",
                    data:{
...
//                    $scope.ansars[i].block_list_status=1;
            ...
            $scope.blockMultiAnsar = function () {
                ...
                $http({
                    method:'post',
                    url:"<?php echo e(URL::route('multi_blocklist_entry')); ?>",
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr ng-if="ansars.length>0" ng-repeat="a in ansars|filter:q as results">
                                ...
                                <td ng-if="0==a.block_list_status">
                                    ...
                                    <?php /*<span ng-if="1==a.block_list_status"  ng-init="status='Blocked'"></span>*/ ?>
