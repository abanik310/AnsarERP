<?php $__env->startSection('title','Direct Offer'); ?>
<?php /*<?php $__env->startSection('small_title','DG'); ?>*/ ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('direct_offer'); ?>
    ...
    <script>
        GlobalApp.controller('DirectOfferController', function ($scope,$http, $timeout, notificationService) {
				...
				$http({
                    ...
                    function (response) {
						...
						if(response.data.status == 'success'){
							...
							$http({
								method:'post',
								url:'<?php echo e(URL::to('HRM/direct_offer')); ?>',
								data:{
            ...
            $scope.cancelOffer = function (e) {
                ...
                $http({
                    method:'post',
                    url:'<?php echo e(URL::to('HRM/direct_offer_cancel')); ?>',
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    <label for="district" class="control-label">Select District to send Offer&nbsp;
                                        <img ng-show="loadingDistrict" src="<?php echo e(asset('dist/img/facebook.gif')); ?>" width="16"></label>
