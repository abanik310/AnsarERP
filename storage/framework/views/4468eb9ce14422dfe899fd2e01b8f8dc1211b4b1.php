<?php $__env->startSection('title','Final Applicant List'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('recruitment.applicant.final_accepted_applicant'); ?>
    ...
    <script>
        GlobalApp.controller('applicantSearch', function ($scope, $http, $q, httpService, $sce, notificationService) {
            ...
            $scope.confirmSelectionAsAccepted = function () {
                ...
                $http({
                    method: 'post',
                    url: '<?php echo e(URL::route('recruitment.applicant.confirm_accepted')); ?>',
                    data: angular.toJson($scope.param)
                }).then(function (response) {
                    $scope.allLoading = false;
            ...
            $scope.uploadFileForm = function(){
                ...
                $scope.allLoading = true;
                $http({
                    url:"<?php echo e(URL::route('recruitment.applicant.confirm_accepted_by_uploading_file')); ?>",
                    data:fd,
                    method:'post',
                    headers:{
