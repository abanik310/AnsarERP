...
<head>
    ...
    <link rel="shortcut icon" href=" <?php echo e(asset('dist/img/favicon.ico')); ?>">
    <!-- Bootstrap 3.3.4 -->
    <link href="<?php echo e(asset('bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css"/>
    <!-- Font Awesome Icons -->
    ...
    <link href="<?php echo e(asset('dist/css/animate.css')); ?>" rel="stylesheet" type="text/css">
    <!-- Theme style -->
    ...
    <style>
        ...
        #loading-box {
            ...
            background-image: url("<?php echo e(asset('dist/img/facebook.gif')); ?>");
    ...
    <div class="login-box-body" style="background: rgba(255,255,255,.32)">
        ...
        <?php if(Session::has('error')): ?>
            <p class="text text-danger"
               style="text-align: center;text-transform: uppercase"><?php echo e(Session::get('error')); ?></p>
        <?php endif; ?>
        <?php if(Session::has('success')): ?>
            <p class="text text-success"
               style="text-align: center;text-transform: uppercase"><i class="fa fa-check"></i>&nbsp;&nbsp;<?php echo e(Session::get('success')); ?></p>
        <?php endif; ?>
        <form action="<?php echo e(URL::route('forget_password_request_handle')); ?>" method="post">
            <?php echo e(csrf_field()); ?>

            <div class="form-group">
                <label style="color: #000;">Enter your user name</label>
                <input type="text" name="user_name" class="form-control" value="<?php echo e(Request::old('user_name')); ?>" placeholder="User Name"/>
                <?php if($errors->has('user_name')): ?>
                    <p class="text text-danger"><?php echo e($errors->first('user_name')); ?></p>
                <?php endif; ?>
            </div>
            <button type="submit" class="btn btn-primary btn-block btn-flat">Submit password change request</button>
        </form>
        <a class="btn btn-link" href="<?php echo e(URL::route('login')); ?>" style="padding-left: 0;color: #ffffff;"><i class="fa fa-angle-left"></i> &nbsp;&nbsp;Back to login</a>
    </div>
