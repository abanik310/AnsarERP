<?php $__env->startSection('title','View Applicant Status Report'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('recruitment.reports.view_applicant_status_report'); ?>
                ...
                link:function (scope,elem,attr) {
                    ...
                    $(elem).ajaxForm({
                        ...
                        success:function(response){
                            ...
                            if(p.status){
                                window.location = '<?php echo e(URL::route('report.download')); ?>?file_name='+p.message
                            }
