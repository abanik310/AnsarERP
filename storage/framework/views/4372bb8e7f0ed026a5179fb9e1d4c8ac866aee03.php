<?php $__env->startSection('title','View Ansar History'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('view_ansar_history'); ?>
    ...
    <script>
        GlobalApp.controller("ViewAnsarHistoryController", function ($rootScope, $scope, $http, $sce) {
            ...
            $scope.loadAnsarDetail = function (id) {
                ...
                $http({
                    method: 'get',
                    url: '<?php echo e(URL::route('view_ansar_history_report')); ?>',
                    params: {ansar_id: id}
            ...
            $scope.showDetailLog = function (log_id) {
                ...
                $http({
                    url: '<?php echo e(URL::to('HRM/log_details')); ?>',
                            method: 'post',
