...
<script>
    ...
    <script>
        $(document).ready(function () {
            var v = "<?php echo e($user->userProfile->bank_name); ?>";
            ...
            $("#user_profile_form").ajaxForm({
                ...
                success: function (response) {
                    ...
                    if (response.submit) {
                        ...
                        window.location.assign("<?php echo e(\Illuminate\Support\Facades\URL::previous()); ?>")
                    }
                    else {
                        $('body').notifyDialog({
                            type: 'error',
                        ...
                        <div id="personal-info" class="tab-pane active">
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-1">
                                    <form id="user_profile_form" action="<?php echo e(action('UserController@updateProfile')); ?>"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="first_name"
                                                       value="<?php echo e($user->userProfile->first_name); ?>"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="last_name"
                                                       value="<?php echo e($user->userProfile->last_name); ?>"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="email" value="<?php echo e($user->userProfile->email); ?>"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="office_phone_no"
                                                       value="<?php echo e($user->userProfile->office_phone_no); ?>"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="mobile_no"
                                                       value="<?php echo e($user->userProfile->mobile_no); ?>"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="contact_address"
                                                       value="<?php echo e($user->userProfile->contact_address); ?>"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="rank" value="<?php echo e($user->userProfile->rank); ?>"
                                        ...
                                        <?php /*<p class="text text-danger " style="font-size: 20px">You only edit your bank account one time</p>*/ ?>
                                        <?php if(!$user->userProfile->bank_name): ?>
                                        <div class="form-group has-feedback">
                                            <label for="rank" class="col-sm-3 control-label"
                                                   style="text-align: left;padding-top:0">Bank Name</label>

                                            <div class="col-sm-9">
                                                <select name="bank_name" value="<?php echo e($user->userProfile->bank_name); ?>"
                                                        class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="form-control">
                                                        <?php echo e($user->userProfile->bank_name); ?>

                                                    </div>
                                                </div>
                                            </div>
                                            <?php endif; ?>
                                        <?php if(!$user->userProfile->branch_name): ?>
                                        <div class="form-group has-feedback">
                                            <label for="rank" class="col-sm-3 control-label"
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="branch_name"
                                                       value="<?php echo e($user->userProfile->branch_name); ?>"
                                        ...
                                        <?php else: ?>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="form-control">
                                                        <?php echo e($user->userProfile->branch_name); ?>

                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if(!$user->userProfile->bank_account_no): ?>
                                        <div class="form-group has-feedback">
                                            <label for="rank" class="col-sm-3 control-label"
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="bank_account_no"
                                                       value="<?php echo e($user->userProfile->bank_account_no); ?>"
                                        ...
                                        <?php else: ?>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="form-control">
                                                        <?php echo e($user->userProfile->bank_account_no); ?>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div style="position: relative;padding: 10px">
                                        <form id="profile_pic" enctype="multipart/form-data"
                                              action="<?php echo e(action('UserController@changeUserImage')); ?>" method="post">
                            ...
                            <div class="row">
                                <?php if(auth()->user()->type==11): ?>
                                    <div class="col-sm-4 col-sm-offset-4">
                                        ...
                                        <form id="user-name-form" action="<?php echo e(action('UserController@changeUserName')); ?>"
                                              method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-4 col-sm-offset-4" style="margin-bottom: 20px">
                                    ...
                                    <form id="user-password-form"
                                          action="<?php echo e(action('UserController@changeUserPassword')); ?>" method="post">
                                        <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
