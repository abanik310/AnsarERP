<?php $__env->startSection('title','Job Circular'); ?>
<?php $__env->startSection('small_title'); ?>
    <a href="<?php echo e(URL::route('recruitment.circular.create')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-clipboard"></i>&nbsp;Add New Circular</a>
    <?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <?php echo Breadcrumbs::render('job_circular'); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr ng-repeat="jc in jobCirculars">
                                ...
                                <td>
                                    <a href="<?php echo e(URL::to('/recruitment/circular')); ?>/[[jc.id]]/edit" class="btn btn-primary btn-sm">
