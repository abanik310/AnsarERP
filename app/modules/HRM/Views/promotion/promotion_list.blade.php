        ...
        GlobalApp.controller('PromotionController', function ($scope, $http, $sce, $parse, notificationService) {
            ...
            $scope.verifyRankPromotion = function (id) {
                ...
                if (id) {
                    $scope.submitting = true;
                    $http({
                        url: "{{URL::to('HRM/verifyRankPromotion')}}",
                        method: 'post',
                        data: angular.toJson({
                            request_id: id
                        })
                                ...
                                <table class="table  table-bordered table-striped" id="ansar-table">
                                    <caption>
                                        ...
                                        {{-- <a class="btn btn-primary btn-xs"
                                           href="{{URL::route('loadPage',['export'=>1])}}">
                                    ...
                                    <tr ng-show="allPromotionAnsar.length>0"
                                        ...
                                        {{-- <td>[[promotionAnsar.reporting_date|dateformat:'DD-MMM-YYYY']]</td>
                        ...
                        <div class="register-box-body  margin-bottom">
                            <div class="row">
                                <div class="col-sm-6">
                                               ...
                                               {{-- <input type="checkbox" show-item="['rank']" ng-model="selected[]" value="checked"
                                               ...
                                               <label for="rankUpdate">Will you want to update?</label><br/>
                                                ...
                                                {{-- <input type="checkbox" id="ansar" style="display:none" name="ranks[]" value="Ansar"> Ansar <br/>
